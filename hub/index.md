                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>电脑桌面应用</h3>
                                                <p>获取工具、了解哪个平台最适合自己的新应用（包括 UWP、WPF、Windows 窗体和 Win32），以及了解如何使用最新的 Windows 功能增强现有的应用。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>UWP 应用</h3>
                                                <p>构建适用于任何 Windows 设备（电脑、手机、Xbox One、HoloLens 以及其他设备）的应用，然后将这些应用发布到 Microsoft Store。 </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>游戏</h3>
                                                <p>创建适用于 Windows 10 设备的 UWP 游戏 - 电脑游戏、Xbox 游戏和混合现实游戏。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Windows IoT</h3>
                                                <p>了解如何在 Windows 10 IoT 核心版上构建。 专为物联网构建的操作系统。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>混合现实</h3>
                                                <p>了解如何使用 HoloLens 和沉浸式耳机打造混合现实体验。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Web</h3>
                                                <p>使用 ASP.NET 为 Microsoft Edge 和现代 Web 应用创建渐进式 Web 应用和浏览器扩展等。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Windows AI</h3>
                                                <p>构建适用于 Windows 和 Windows 设备的智能应用。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>使用 Python 进行开发</h3>
                                                <p>无论你是构建跨平台 Web 应用、使用脚本自动执行常见任务，还是首次在教育环境中学习 Python，我们都将帮助你安排好在 Windows 上使用 Python 进行开发所需的一切。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>开发</h3>
                                                <p>使用 Windows 驱动程序工具包 (WDK) 开发、测试和部署驱动程序。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>了解如何计划、部署、扩展 Windows Server 2019 和 Windows Server 2016 并增强其安全性。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>适用于企业的 Microsoft Store</h3>
                                                <p>了解如何使用适用于企业的 Microsoft 应用商店为企业查找、获取、分配和管理应用。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>适用于教育的 Microsoft Store</h3>
                                                <p>了解如何使用适用于教育的 Microsoft Store 为学校查找、获取、分配和管理应用。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Windows 隐私</h3>
                                                <p>了解 Windows 中的隐私并根据一般数据保护条例 (GDPR) 做好准备。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
