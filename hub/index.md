...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a data-default="true" href="#developer">开发人员</a>
            <ul id="developer">
                <li>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>UWP 应用</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/apps/getstarted">入门</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/apps/design">设计</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/develop">开发</a>
                                            </p>
                                            <p>
                                                <a href="https://msdn.microsoft.com/windows/uwp/publish/index">发布</a>
                                            </p>
                                            <p>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/desktop/design">设计</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/desktop/develop">开发</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/desktop/app-compatibility">兼容性</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/desktop/test-deploy">测试和部署</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>游戏</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/getstarted">入门</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/design">UI 设计</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/develop">开发</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/publish">发布</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>IoT</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/iot/Docs">文档</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/iot/Downloads">下载</a>
                                            </p>
                                            <p>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>
                                                <a href="https://developer.microsoft.com/microsoft-edge/testdrive/">演示</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>自定义</h3>
                                                <p>将设置、语言和驱动程序应用到 Windows 10 映像。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>了解如何计划、部署、扩展 Windows Server 2016 并增强其安全性。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>浏览器</h3>
                                                <p>了解如何部署和管理 Microsoft Edge 和 Internet Explorer 11。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
