...
有关在 Windows 应用中使用语音交互的不同方法的更多信息，请参阅[语音交互](/windows/uwp/design/input/speech-interactions)。
