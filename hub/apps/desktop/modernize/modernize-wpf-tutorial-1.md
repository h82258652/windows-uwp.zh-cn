...
在本教程的此部分中，你要将整个 Contoso 支出应用从 .NET Framework 4.7.2 迁移到[.Net Core 3](modernize-wpf-tutorial.md#net-core-3)。 在开始本教程部分之前，请确保打开并生成 Visual Studio 2019 中[的 ContosoExpenses 示例](modernize-wpf-tutorial.md#get-the-contoso-expenses-sample-app)。
