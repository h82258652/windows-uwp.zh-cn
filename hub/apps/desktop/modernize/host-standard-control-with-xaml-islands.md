...
7. 生成 UWP 应用项目。
8. 在 WPF 项目中，添加对 UWP 应用项目的引用。 

    * 如果 WPF 项目面向 .NET Core，请右键单击“依赖项”节点，添加对 UWP 应用项目的引用。 
    * 如果 WPF 项目面向 .NET Framework，请右键单击项目节点，选择“生成依赖项” -> “项目依赖项”，然后选择 UWP 应用项目 。
