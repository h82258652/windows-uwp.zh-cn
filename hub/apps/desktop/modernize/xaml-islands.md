...
### <a name="step-1-modify-your-project-to-use-windows-runtime-apis"></a>步骤 1：修改项目以使用 Windows 运行时 Api
...
> [!NOTE]
> 当您将添加**maxversiontested**元素中的为应用程序清单，可能会看到以下生成你的项目中的警告： `manifest authoring warning 81010002: Unrecognized Element "maxversiontested" in namespace "urn:schemas-microsoft-com:compatibility.v1"`。 此警告并不表示任何内容是在项目中，错误，则可以忽略它。
