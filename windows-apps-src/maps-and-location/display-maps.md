---
“使用 2D、3D 和街景视图显示地图”
通过使用 MapControl 类，在应用中显示可自定义的地图。 本主题还介绍了鸟瞰图 3D 视图和街景视图。
...
在地图上设置要显示的位置，方法为在代码中指定 [**MapControl**](https://msdn.microsoft.com/library/windows/apps/dn637004) 的 [**Center**](https://msdn.microsoft.com/library/windows/apps/dn637005) 属性或在 XAML 标记中绑定属性。 以下示例以西雅图市为中心显示地图。
