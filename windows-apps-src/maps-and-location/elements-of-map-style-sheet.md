...
| >> area                      | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 描述陆地的区域使用。  这些不应与物理建筑物的结构项下的混淆。 |
...
| shadowColor                  | Color   |      |      |      |  ✔️   | 使用阴影的图标隐藏阴影的颜色。 |
