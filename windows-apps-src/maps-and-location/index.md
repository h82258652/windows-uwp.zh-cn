...
> [!TIP]
> 若要了解有关你的应用中使用地图和位置的详细信息，请从 GitHub 上的[Windows 通用示例存储库](https://go.microsoft.com/fwlink/p/?LinkId=619979)下载以下示例：
