...
如果使用枚举 API，你将经常需要使用 [**DeviceInformation**](https://msdn.microsoft.com/library/windows/apps/BR225393) 对象。 这些对象包含大多数可用的设备信息。 下表将介绍你感兴趣的一些 **DeviceInformation** 属性。 有关完整列表，请参阅 **DeviceInformation** 参考页面
...
| **DeviceInformation.Kind**       | 这指示了使用 [**DeviceInformation**](https://msdn.microsoft.com/library/windows/apps/BR225393) 对象表示的设备对象类型。 这并不是设备类别或设备类型。 单个设备可使用若干个不同的 **DeviceInformation** 对象（不同种类）来表示。 [
            **DeviceInformationKind**](https://msdn.microsoft.com/library/windows/apps/BR225393kind) 中列出了此属性可能具有的值以及这些值相互关联的方式。                           |
...
-   你可以使用 [**Appearance**](https://msdn.microsoft.com/library/windows/apps/windows.devices.enumeration.devicepicker.appearance) 更改 [**DevicePicker**](https://msdn.microsoft.com/library/windows/apps/Dn930841) 的外观
...
**注意** 不能使用 [**DevicePicker**](https://msdn.microsoft.com/library/windows/apps/Dn930841) 指定 [**DeviceInformationKind**](https://msdn.microsoft.com/library/windows/apps/BR225393kind)。 如果想要拥有特定的 **DeviceInformationKind** 设备，你将需要生成一个 [**DeviceWatcher**](https://msdn.microsoft.com/library/windows/apps/BR225446) 并提供你自己的 UI。
