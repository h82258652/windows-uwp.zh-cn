...
<br/>
显示设备选取器 UI，并让用户选择已连接的设备。 此方法处理更新列表，当设备连接并删除，并简单且安全比其他方法。
