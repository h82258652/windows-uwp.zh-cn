...
| **System.Devices.Aep.CanPair**        | 布尔值    | 指示设备是否可以与系统匹配。 [
            **DeviceInformationPairing.CanPair**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.devices.enumeration.deviceinformation.pairing.aspx_canpair) 派生自此属性。                                                                                                                                                                                                                                                                                                       |
...
| **System.Devices.Aep.IsPaired**       | 布尔值    | 表明设备当前是否已配对。 [
            **DeviceInformationPairing.IsPaired**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.devices.enumeration.deviceinformation.pairing.aspx_ispaired) 派生自此属性。                                                                                                                                                                                                                                                                                                                      |
