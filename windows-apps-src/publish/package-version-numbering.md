...
这将为你随时间推移不断优化你的应用提供了极大的灵活性。 你可以上传和提交新程序包，使用较低版本号添加对你之前不支持的 Windows 10 设备的支持，你可以添加具有更为严格的相关性充分利用硬件或操作系统功能，或你的版本号较高的程序包可以添加版本号较高的程序包，用作对部分或全部现有客户群。
...
若要为已收到有问题的程序包的客户解决此问题，你可以提交新的 Windows 10 程序包，只要你可以具有更高版本的版本号，与程序包。 在该提交完成认证过程后，所有客户的程序包都将更新为新程序包，因为它具有更高的版本号。
