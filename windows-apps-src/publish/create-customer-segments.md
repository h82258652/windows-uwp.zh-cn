...
ms.locfileid: "63813522"
---
# <a name="create-customer-segments"></a>创建客户类别

有时出于促销和提升参与度的目的，可能需要面向客户群子集。 可以实现此目标[合作伙伴中心](https://partner.microsoft.com/dashboard)通过创建一种[客户组](create-customer-groups.md)称为*段*包括 Windows 10 客户满足人口统计或你选择的收入条件。
...
5.  在**定义包含条件**部分中，指定类别的筛选条件。
    ...
    可以选择使用不同的筛选条件，包括**收购**，**获取源**，**人口统计**，**评级**，**客户流失预测**，**存储购买**，**存储收购**，以及**Store 花费**。
