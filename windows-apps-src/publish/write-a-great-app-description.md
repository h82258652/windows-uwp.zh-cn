---
出色的提要可以让你的应用在 Windows 应用商店中脱颖而出，并有助于鼓励用户下载它。
编写出色的应用提要
...
-   **开头几句话就要吸引眼球。** 提要的开头部分最为重要，所以一定要确保能够吸引和抓住注意力。 想想怎样能够用一两句话来解释应用的独特吸引力，促使他人决定购买。
...
-   **不要包含链接或其他位置上的信息。** 你在提要字段中输入的 URL 不可单击，因此不要尝试添加诸如隐私策略或支持网站等内容的链接。 而是在**“应用提要”**页面的指定区域中添加这些内容。
