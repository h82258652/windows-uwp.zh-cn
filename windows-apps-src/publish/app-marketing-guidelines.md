...
我们创建了特殊的促销锁屏提醒，帮助你带动更多客户的 Microsoft 应用商店中你的应用的一览。 这些锁屏提醒在 44 种语言中可用。 请记住，使用这些图像时需要遵循一些要求；这些要求以及使用示例和指南将以 PDF 文件形式提供。
...
*Microsoft 商标授权*意味着*Microsoft 锁屏提醒*[锁屏提醒生成器](http://go.microsoft.com/fwlink/p/?LinkID=534236)页面上所述。 若要使用这些锁屏提醒，必须满足以下条件：
