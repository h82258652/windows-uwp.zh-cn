...
-   “待付款”****显示待付款数、下次付款的金额和付款创建日期。 如果你符合条件的收益尚未达到付款阈值，则此处将不会显示任何待付款。 你可以单击“查看详细信息”****查看其他信息，包括付款金额及其各自的收入来源。 当金额显示在“待付款”****部分中时，将看到指向“下载交易记录”****的临时链接。  如果单击此链接，将看到组成待付款的所有交易的 .csv 文件。  请注意：如果“待付款”****金额移至“最近的付款”****，则将不会显示“下载交易记录”****链接。
