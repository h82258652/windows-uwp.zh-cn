...
> [!NOTE]
> 若要可用于付款，收益必须达到相应的[付款阈值](payment-thresholds-methods-and-timeframes.md)。 如果收益少于付款阈值，则将保留在**预留**类别中，直到达到此阈值。 有关应用收益的支付阈值的详细信息，请参阅[应用开发人员协议](https://msdn.microsoft.com/library/windows/apps/hh694058)。 对于广告收益，付款阈值是 50 美元（或本地货币的对等值）。 
>
