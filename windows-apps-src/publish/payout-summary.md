...
若要查看你**付款摘要**，单击**付款**合作伙伴中心，在右上角附近出现图标，然后选择**付款摘要**。

## <a name="current-proceeds-and-payments"></a>当前收益和付款

靠近页面顶部，您会发现你**当前继续和付款**，其中包含三个部分：**保留**，**即将到来的付款**，和**最近付款**。

-   “预留”会显示你的帐户已经累积但尚未计划用于付款的金额，包括广告收益。 (但不位于 azure Marketplace 将继续**保留**部分; 如果您仅参与 Azure Marketplace，你将看到 $0.00 此处。)将继续从销售大约 30 天，适合付款之前处于挂起状态的最新应用。 在此之后，这些收益将计划用于下个月的付款（假设已达到[付款阈值](payment-thresholds-methods-and-timeframes.md)）。 当尝试付款时，你的预留余额中会减去付款金额，并且你会看到该金额显示在“待付款”中。 请注意，“预留”中显示的金额是估算值，因为使用其他货币销售的汇率可能会在付款创建前有所波动。 你可能注意到你的预留余额会在每月初发生轻微的变化。 你的预留余额会进行每月更新，以反映每个月的汇率，以便显示更精确的估算值。 你可以单击“查看详细信息”查看其他信息，或单击指向“下载预留交易”的链接以查看所有“预留”交易的 .csv 文件。
