...
公司帐户花费稍多，这主要是因为我们要采取一些额外步骤来确保你有权代表公司建立该帐户。 根据应用[商店策略](store-policies.md#1014-account-type)，具有特定功能的应用，如访问财务帐户信息或需要身份验证访问主要功能的应用程序（不使用安全的专用第三方身份验证提供程序）。只能由公司帐户发布。
