...
> [!IMPORTANT]
> 你可以为保留其他名称应用，并且你可以选择使用其中一个引擎在你的应用的已发布版本而不是一个你保留在合作伙伴中心中首先创建你的应用时。 但是，请注意，将某些你的应用[标识详细信息](view-app-identity-details.md)，如**程序包系列名称 (PFN)** 中使用你在此处输入的第一个名称。 这些值可以显示给某些用户，且不能更改，因此请确保为此，请使用适合你保留的名称。
