...
**总销售**你的应用 （从 2016 年 10 月-存在)，还提供在此图表中显示的应用销售 （中美元） 从赚取的总金额。 请注意，此金额不考虑任何退款、 撤单、 拒付等。
...
在**每日应用**视图中，选中**30d**时间段后，你可能会看到圆圈标记。 这些表示显著增加或减少在我们认为你会想要了解有关为给定值。 在其出现圆的日期表示一周中，我们检测到了显著增加或减少相对于前的一周结尾。 若要查看有关更改内容的更多详细信息，请悬停在圆圈。  
