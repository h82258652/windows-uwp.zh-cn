...
1.  从[合作伙伴中心](https://partner.microsoft.com/dashboard)，选择 （附近的仪表板右上角） 的齿轮图标，然后选择**开发人员设置**。 在**设置**菜单中，选择**租户**。
2.  选择**创建新 Azure AD**。
