...
**私人受众**选项适用于面向任何操作系统版本的应用，但你的测试人员必须运行 Windows 10 版本 1607 或更高版本（包括 Xbox One），并且必须使用与你提供的电子邮件地址相关联的 Microsoft 帐户登录。
...
此选项提供了另一种方法，可将应用限制为仅分配给某组测试人员，并且无需首先发布广泛可用的提交。 但是，与私人受众选项不同，如果有直接链接，任何人都可能看到你的应用的一览。 如果保密性对于你的提交至关重要，我们建议改为发布到私人受众。
