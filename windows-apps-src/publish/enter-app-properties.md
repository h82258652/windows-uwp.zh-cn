...
仅当选择**游戏**作为你的产品类别时，才显示此选项。 可在此处指定你的游戏支持的功能。 在本部分中提供的信息将显示在产品的商店列表。
...
- **Windows 上的客户 8.x 及更早版本或 Windows Phone 8.x 及更早版本：**
