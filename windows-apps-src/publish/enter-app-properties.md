...
ms.locfileid: "79210753"
---
# <a name="enter-app-properties"></a>输入应用属性

使用**应用提交过程**的[属性](app-submissions.md)页，你可以定义应用类别并输入其他信息和声明。 请务必在此页面上提供有关你的应用的完整准确的详细信息。
...
输入你的应用的网页 URL。 该 URL 必须指向你自己网站上的某个页面，而不是应用商店中你的应用的 Web 一览。 此字段是可选的，但建议使用它。
...
- 在显示于**属性**页面下方的**系统要求**部分，为 **Windows Mixed Reality 沉浸式头戴显示设备**选择[最低硬件](#system-requirements)或**推荐硬件**。
...
- **适用于 Windows 8.x 和更早版本的客户或 Windows Phone 3.x 及更早版本：**
