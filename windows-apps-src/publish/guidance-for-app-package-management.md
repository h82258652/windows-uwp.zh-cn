...
在示例应用 4 中，运行 Windows 10 的任何设备都可获得该应用，但不会向使用任何以前操作系统版本的客户提供该应用。 由于 UWP 程序包面向通用设备系列，它将适用于任何 Windows 10 设备 （每个[设备系列可用性选择](device-family-availability.md)）。
