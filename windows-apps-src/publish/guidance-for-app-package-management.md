...
如果你删除的某些[设备系列](https://docs.microsoft.com/uwp/extension-sdks/device-families-overview)的支持你的应用之前，将提示你确认，这是你的意图，你可以在**程序包**页面上保存更改之前的所有程序包。
...
如果你有一个应用中仅包括包在 Windows 应用商店 8.x 和/或 Windows Phone 8.x，并且你想要为 windows 10 更新你的应用、 创建新提交并在[程序包](upload-app-packages.md)阶段添加 UWP.msixupload 或.appxupload 程序包。 你的应用完成认证过程后，还将适用于 windows 10 的客户通过新的购置 UWP 程序包。

> [!NOTE]
> 在 windows 10 上的客户获取 UWP 程序包后, 您不能回退到使用任何以前操作系统版本的程序包滚动该客户。 
