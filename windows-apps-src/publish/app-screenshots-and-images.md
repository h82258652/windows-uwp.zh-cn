...
与 Microsoft Store 一览页中的其他字段相似，预告片必须通过认证才能发布到 Microsoft Store 中。 请确保预告片遵守 [Microsoft Store 策略](https://msdn.microsoft.com/library/windows/apps/dn764944.aspx)。
