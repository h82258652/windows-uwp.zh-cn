...
在生成你的应用的 UWP 程序包时，Visual Studio 可以创建.msix appx 文件或在.msixupload 或.appxupload 文件。 对于 UWP 应用，我们建议你始终上传.msixupload 或.appxupload 文件中的[程序包](upload-app-packages.md)页面。 有关如何打包 UWP 应用以上架 Microsoft Store 的详细信息，请参阅[使用 Visual Studio 打包 UWP 应用](../packaging/packaging-uwp-apps.md)。
