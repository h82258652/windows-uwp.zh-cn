...
你可能在 pubCenter 和开发人员中心中拥有多个帐户，并且你的迁移体验将取决于 pubCenter 帐户和开发人员中心帐户的具体设置。 以下一个或多个方案可能适合你。 请仔细阅读适用于你的方案的详细信息。

## 方案 \#1：你拥有使用相同的 Microsoft 帐户的开发人员中心帐户和 pubCenter 帐户（在同一国家/地区注册）


**示例**：你拥有在美国使用 \[name\]@outlook.com 注册的开发人员中心帐户。 你还拥有在美国使用 \[name\]@outlook.com 注册的 pubCenter 帐户。
...
-   在开发人员中心中使用的付款方式和税收详细信息将同样用于 pubCenter 付款。 仅可以从开发人员中心编辑你的付款方式和税收详细信息。 这意味着：
    ...
    -   如果你未在开发人员中心或 pubCenter 中设置付款方式或税收详细信息，请在开发人员中心中设置它们，并且相同的付款方式或税收详细信息将同样用于 pubCenter 付款。 有关在开发人员中心中管理付款方式和税收详细信息的更多信息，请参阅[设置付款帐户和税单](setting-up-your-payout-account-and-tax-forms.md)。
    -   将使用 pubCenter 中设置的付款方式和税收详细信息进行 pubCenter 付款，直到在开发人员中心中设置付款方式和税收详细信息。 如果已在开发人员中心中设置了它们，则开发人员中心中设置的付款方式和税收详细信息将取代你的 pubCenter 付款方式和税收详细信息。 有关详细信息，请参阅 [pubCenter-DevCenter 付款帐户和税务资料整合](pubcenter-devcenter-payout-account-and-tax-profile-consolidation.md)。
...
**示例**：你拥有在美国使用 \[name\]@outlook.com 注册的开发人员中心帐户。 你还拥有在印度使用 \[name\]@outlook.com 注册的 pubCenter 帐户。
...
-   你将需要在开发人员中心中管理来自新的广告单元的收入的付款方式和税收详细信息。 有关在开发人员中心中管理付款方式和税收详细信息的详细信息，请参阅[设置付款帐户和税单](setting-up-your-payout-account-and-tax-forms.md)和 [pubCenter-DevCenter 付款帐户和税务资料整合](pubcenter-devcenter-payout-account-and-tax-profile-consolidation.md)。
-   你的开发人员中心帐户现在提供你的付款报告。 有关开发人员中心中的付款报告的详细信息，请参阅[付款摘要](payout-summary.md)。
-   现在，所有应用促销市场活动已与开发人员中心帐户关联，你可以从开发人员中心直接管理它们。
...
**示例**：你拥有使用 \[name\]@outlook.com 注册的开发人员中心帐户。 你还拥有使用 \[other\_name\]@outlook.com 注册的 pubCenter 帐户。

**结果**：你需要手动将 pubCenter 帐户链接到你的开发人员中心帐户。 为此：

1.  登录到你希望链接的 pubCenter 帐户。
2.  在此帐户的“我的信息”****页面上，你将找到“pubCenter 帐户链接代码”****。 使此代码保持可用。

    > **注意** 每隔 60 分钟将会生成新的帐户链接代码。
...
-   请确保将你的所有 pubCenter 帐户（以及不匹配的 Microsoft 帐户）链接到你要在其中管理它们的开发人员中心帐户。
-   不要在 pubCenter 中注册新帐户，除非你希望从 Xbox 应用盈利。 现在可以在开发人员中心帐户中管理你的所有盈利和应用促销需求。
-   你将无法继续在 pubCenter 中创建新的广告单位。 以后只能在开发人员中心中创建新的广告单元。 如果你希望编辑你的现有广告单元，请联系支持人员。
-   可能已在相同的 Microsoft 帐户下为你创建了新的 pubCenter 帐户，从而将你的开发人员中心帐户与同一 Microsoft 帐户链接。 使用 pubCenter 页面右上角的新帐户下拉菜单查看和管理其他 pubCenter 帐户的信息。
-   若要收到在开发人员中心中创建的新广告单元上获得的收入，你必须在开发人员中心中设置付款和税收方式。 有关详细信息，请参阅 [pubCenter-DevCenter 付款帐户和税务资料整合](pubcenter-devcenter-payout-account-and-tax-profile-consolidation.md)。
...
-   你的 pubCenter 帐户尚未链接到你的开发人员中心帐户。
...
如果你正在使用最新版本的[广告中介扩展](http://go.microsoft.com/fwlink/p/?LinkId=518026)，当你将应用上载到 Windows 应用商店时，我们将为你自动创建一个新的广告单元。 你无需再转到 pubCenter 并手动创建新的广告单元。 如果广告单元创建由于某些原因而失败，你将收到一封电子邮件，其中附带有关建议的后续步骤的详细信息。
...
使用你用于开发人员中心的相同 Microsoft 帐户登录到 pubCenter，并确保你的付款和税收方式设置准确。 如果获得的收益超出阈值限制，你将在当月的第一周内收到这些新广告单元的付款。

### 我无法在 pubCenter 中创建新的应用促销活动。 我的一些应用促销活动也已被自动暂停。 这是否符合预期？

以后你将只能够在开发人员中创建应用促销活动。 pubCenter 中你的一些应用促销活动可能已暂停，作为此集成的一部分。 以后请在开发人员中创建新的应用促销活动。
...
如果将同一个 Microsoft 帐户与 pubCenter 和开发人员中心帐户相关联，你的帐户将进行自动链接，并且你将开始在开发人员中心帐户中看到 pubCenter 收益报告。 如果你的 pubCenter 和开发人员中心帐户已与不同的 Microsoft 帐户相关联，在你将 pubCenter 帐户链接到开发人员中心帐户 24 小时后，你将开始在开发人员中看到 pubCenter 帐户收益报告。

### 何时需要完成将 pubCenter 帐户链接到开发人员中心帐户的操作？

我们建议你确保尽早将你的所有 pubCenter 帐户链接到你的开发人员中心帐户。

### 我现在可以在 pubCenter 仪表板中看到新帐户下拉菜单。 这是什么？

作为 pubCenter 开发人员中心集成的一部分，已在后端为你创建一个新的 pubCenter 帐户，用于链接到你的开发人员中心帐户。 在此 pubCenter 帐户下拉菜单中，你可以选择要查看其数据的帐户。

### 我看到 pubCenter 和 Dev Center 中报告的数据之间存在微小的差异。 这是否符合预期？

是的，pubCenter 和开发人员中心报告中显示的数据可能存在微小的差异。 这可能是因为 pubCenter 中的数据以 pubCenter 帐户的时区报告，而开发人员中心中的数据以 UTC 报告。
