...
- **改动预期**： 显示有多少用户我们预测可能很快停止使用你的应用，具体取决于其最近的使用情况。

**30d**选定时间段后，你可能会看到圆圈标记，当查看**用户**、**设备**或**持续时间**的选项卡。 这些表示显著增加或减少我们认为你想要了解有关为给定值。 在其出现圆的日期表示一周中，我们检测到了显著增加或减少相比于前的一周结尾。 若要查看有关更改内容的更多详细信息，请悬停在圆圈。  
