...
**30 D**选定时间段后，您可能会看到圆形标记，查看**用户**、**设备**或**持续时间**选项卡时。 这些表示显著增加或减少我们认为您需要了解的给定值。 在这个圆将显示该日期表示我们检测显著增大或减小相比于之前的周的一周的末尾。 若要查看有关已更改内容的更多详细信息，请悬停在这个圆。  
