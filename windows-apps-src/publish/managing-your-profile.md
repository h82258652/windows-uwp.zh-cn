...
请选择仪表板右上角的齿轮图标，然后单击**帐户设置**。 在此可查找关于帐户的详细信息，及指向可查看和/或更新信息以及执行多种帐户相关任务的其他页面的链接。

在**帐户详细信息**部分中，可以查看帐户的状态和类型。 还可以查看发布者 ID 信息，包括卖家 ID、Windows 发布者 ID 和 Windows Phone 发布者 ID。 这些值由 Microsoft 分配以唯一地标识开发者帐户。 无法编辑这些值。
...
- **Xbox One 开发主机**：查看和管理[为开发启用的 Xbox One 主机](../xbox-apps/devkit-activation.md)。 
