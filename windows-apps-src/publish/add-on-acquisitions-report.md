...
在页面顶部附近，可以选择希望显示数据的时间段。 默认选择为 **30D**（30 天），但你可以选择要显示 3、6 或 12 个月的数据或指定的自定义数据范围的数据。 你还可以选择**1 H**或**72h**显示近乎实时的一个小时或有 70 两小时; 购置数据这些时间段仅应用于**加载项购置**图的**每天加载项**选项卡和**市场**图的**购置**选项卡。 
