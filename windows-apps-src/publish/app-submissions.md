...
> [!NOTE]
> 你必须拥有才能访问[Windows 开发人员中心](https://partner.microsoft.com/dashboard)和提交到 Microsoft 应用商店应用[开发者帐户](http://go.microsoft.com/fwlink/p/?LinkId=615100)。
