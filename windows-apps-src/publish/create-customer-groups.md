...
ms.locfileid: "2811016"
---
# <a name="create-customer-groups"></a>创建客户组

您可以创建*客户组*包含您的应用程序客户的子集。 这些组可用于到目标客户升级、 测试和其他目的。

要查看和创建客户组，请展开**接洽** [Windows 开发人员中心](https://partner.microsoft.com/dashboard)的左侧的导航菜单中，然后选择**客户组**。
