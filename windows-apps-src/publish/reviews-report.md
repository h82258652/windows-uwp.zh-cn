...
ms.locfileid: "6030169"
---
# <a name="reviews-report"></a>评价报告


[合作伙伴中心](https://partner.microsoft.com/dashboard)中的**评价**报告可使你可以查看时在应用商店中的对应用进行评分输入客户的评论 （注释）。
...
你可以使用搜索框来搜索特定的字词或短语，在你的应用的评价。 注意，搜索仅原始评论文本撰写的客户，即使在另一种语言编写评价。 翻译的评论文本不会搜索。
...
如上所述，当搜索你的评论，搜索仅留下的客户的原始文本 （并不是任何已翻译的文本），即使你已**翻译评论**框处于选中状态。
