...
Windows 应用商店的客户遍及世界 200 多个国家和地区。 可选择要推出你的应用的市场，按市场或市场组自定义许多[定价和可用性](set-app-pricing-and-availability.md)功能。

请务必考虑我们的[帮助你将自己的应用全球化的指南](../globalizing/guidelines-and-checklist-for-globalizing-your-app.md)。
...
可以选择在以下一个或多个市场中列出的应用（或加载项）。 带星号的市场支持 Xbox 上的应用商店；**市场选择**弹出窗口中，市场名称旁边显示 **Xbox**。
...
如果你的应用包含面向 Windows 8.x 的程序包，则请务必注意，对于在 Windows 8.x 上使用应用商店的客户，一些市场将被视为单个“世界其他地区”市场，即使它们在 Windows 开发人员中心仪表板中显示为个别市场也是如此（与早期的 Windows 应用商店仪表板相反，其中曾有一个可选择的“世界其他地区”市场选项）。
