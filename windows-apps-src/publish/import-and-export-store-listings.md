...
请记住，你始终可以创建或更新直接合作伙伴中心中的一览 （即便你先前已使用导入/导出方法）。 在合作伙伴中心中直接更新可能更方便，当你只进行了简单更改，但你可以在任何时候使用任何一种方法。
...
无.csv 文件中的信息将保存在合作伙伴中心直到你文件中的错误的所有已解决，即使对于且没有错误的字段。 一旦导入没有错误的.csv 文件之后，你所提供的一览信息将保存在合作伙伴中心中，并将用于该提交。
