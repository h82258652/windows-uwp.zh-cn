...
此部分中的字段均为可选字段。 应用功能和系统要求可用于帮助客户更好地了解应用的功能以及获得最佳体验需要满足的要求。 其他选项可帮助在不同的场景中为产品提供最佳体验。 请查看以下信息确定提供此信息是否对你的提交有帮助。
...
仅用于游戏。 此说明出现在 Xbox One 上游戏中心的“信息”部分，帮助客户了解有关你的游戏的更多信息。
