...
ms.locfileid: "67495704"
---
# <a name="payment-thresholds-methods-and-timeframes"></a>付款阈值、方法和时间范围

具体取决于你的国家/地区和付款帐户类型而异的估计的时间传输付款和 Microsoft 应用商店可从中接收付款。 本主题概述了支持每个国家/地区中的付款方法。
...
## <a name="payment-methods-in-countriesregions"></a>在国家/地区的付款方法

> [!NOTE]
> 在所有区域中的付款阈值为 50 美元。

| Country                          | Azure 应用商店 | 应用商店、 广告、 Mixer 和 Minecraft | Office | PayPal 付款 |
|----------------------------------|-------------------|------------------------------------------|--------|-----------------|
| 阿富汗                      | 是               | 是                                      | 否     | 否              |
| 阿尔巴尼亚                          | 是               | 是                                      | 是    | 是             |
| 阿尔及利亚                          | 是               | 是                                      | 是    | 是             |
