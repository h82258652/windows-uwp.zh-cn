...
通过合作伙伴中心运行安装广告市场活动，可为播发应用提供很多需要的风险。 将向最有可能对应用感兴趣的客户显示广告曝光，此类客户可单击广告并通过应用商店安装应用。 以前，难以分辨安装量是源于广告市场活动还是其他来源所致。
...
3.  客户满足 [COPPA](https://www.ftc.gov/enforcement/rules/rulemaking-regulatory-reform-proceedings/childrens-online-privacy-protection-rule) 要求（无法跟踪不满足 COPPA 要求的客户）。

因此，应用安装跟踪有可能低估由广告市场活动所产生的实际安装量。 请注意，你可以在合作伙伴中心的 "[收购](acquisitions-report.md)" 报表中查看应用的安装总数（通过市场活动，以其他方式）。
