...
| [入门：导航](getting-started-navigation.md) | 在 Windows 10 应用中管理此导航的方法之一是使用 [Frame](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Frame) 类。 以下演练将向你展示如何尝试执行此操作。 |
...
| [Windows 应用程序的概念映射](https://docs.microsoft.com/windows/uwp/porting/android-ios-uwp-map) | 如何以 Windows（和 Android）功能术语考虑 iOS 概念 |
