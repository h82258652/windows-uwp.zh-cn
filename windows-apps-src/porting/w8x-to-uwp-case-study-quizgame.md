...
# <a name="windows-runtime-8x-to-uwp-case-study-quizgame-peer-to-peer-sample-app"></a>Windows 运行时 8.x 到 UWP 案例研究：QuizGame 对等示例应用
...
**注意**   在 Visual Studio 中打开 QuizGame10 时，如果你看到消息“需要 Visual Studio 更新”，则按照 [TargetPlatformVersion](w8x-to-uwp-troubleshooting.md) 中的步骤进行操作。
