---
author: normesta
Description: "在桌面应用和 UWP 应用之间共享代码"
Search.Product: eADQiWindows 10XVcnh
title: "在桌面应用和 UWP 应用之间共享代码"
ms.author: normesta
ms.date: 10/03/2017
ms.topic: article
ms.prod: windows
...
![Windows 设备](images/desktop-to-uwp/windows-devices.png)
...
假设我们有一个非常基本的 Windows 窗体应用，该应用显示我们 Northwind 示例数据库中的客户。
...
若要开始使用 UWP，请参阅[通用 Windows 平台简介](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide)。
...
有问题？ 请在 Stack Overflow 上向我们提问。 我们的团队会监视这些[标记](http://stackoverflow.com/questions/tagged/project-centennial+or+desktop-bridge)。
