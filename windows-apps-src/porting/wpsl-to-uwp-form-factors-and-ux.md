...
translationtype: HT
---
#  <a name="porting-windows-phone-silverlight-to-uwp-for-form-factor-and-ux"></a>针对外形规格和 UX 将 Windows Phone Silverlight 移植到 UWP
...
除了内置于系统控件和布局面板的动态布局外，我们还可以使用名为[“自适应视觉状态管理器”](wpsl-to-uwp-porting-xaml-and-ui.md)的新 Windows 10 功能。
