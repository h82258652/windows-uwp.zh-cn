...
**请注意**  Windows 10 比 Windows Phone 应用商店应用支持更多的 .NET Framework。 例如，Windows 10 有多个 @no__t 的命名空间，以及 System.Net、System.net.networkinformation 和系统的 .Net。
...
| 图形和动画 | |
| **@No__t-1**命名空间、个带空间[框架](https://go.microsoft.com/fwlink/p/?LinkId=263769)类库、[内容管道](https://go.microsoft.com/fwlink/p/?LinkId=263770)类库 | 无直接等效项。 通常情况下，结合使用 [Microsoft DirectX](https://docs.microsoft.com/windows/desktop/directx) 和 C++。 请参阅[开发游戏](https://docs.microsoft.com/previous-versions/windows/apps/hh452744(v=win.10))和 [DirectX 和 XAML 互操作](https://docs.microsoft.com/previous-versions/windows/apps/hh825871(v=win.10))。 |
