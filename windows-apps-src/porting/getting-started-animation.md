...
可手动编辑此 XAML，或返回到 Blend 以继续在其上执行操作。 Blend 使创建有趣的用户界面变得很有意思，并且使用图形工具设置界面动画的能力可极大加快开发速度。 有关动画的详细信息，请参阅[动画概述](https://docs.microsoft.com/windows/uwp/graphics/animations-overview)。

**请注意**  有关的动画效果的信息<span class="legacy-term">UWP 应用使用 JavaScript 和 HTML</span>，请参阅[进行动画处理您的用户界面 (HTML)](https://docs.microsoft.com/previous-versions/windows/apps/hh465165(v=win.10))。
