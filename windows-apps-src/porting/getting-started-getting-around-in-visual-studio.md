...
现在让我们写一些代码，以便在用户点击该按钮时将TextBlock控件的内容更改为“Hello, World!” 。
...
若要为按钮的单击事件添加代码，请先在“设计”窗格中选择按钮。 接下来，单击闪电按钮，然后双击名称“单击”旁边的空白框。 Visual Studio 然后将事件添加"myButton\_单击"向**单击**框，然后添加并在 MainPage.xaml.cs 文件中，此类将显示相应的事件处理程序。
...
现在让我们关联TextBlock控件。 在 Xcode 中，将按钮控件拖动至源代码文件，以将控件与其定义关联，如下所示。
...
[入门：公共控件](getting-started-common-controls.md)
