...
对**“TextBlock”**控件执行相同操作，于是其外观如下所示：
...
使用 Visual Studio 时，将执行非常相似的操作。 在**“设计”**窗格中，点击按钮赋予其焦点。 然后在**“属性”**窗格中，将**“内容”**值从“按钮”更改为“点击我”。 接下来，通过将**“名称”**值从“<No Name>”更改为“myButton”，更新按钮控件名称，如下所示：
