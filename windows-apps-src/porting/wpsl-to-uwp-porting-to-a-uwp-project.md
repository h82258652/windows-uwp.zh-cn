---
description: 通过在 Visual Studio 中创建一个新的 windows 10 项目，并将文件复制到其中开始移植过程。
...
通过在 Visual Studio 中创建一个新的 windows 10 项目，并将文件复制到其中开始移植过程。
...
如果是这样，而现在想要支持除此之外的 windows 10，然后你可以这样做，过。
