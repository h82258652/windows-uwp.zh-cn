...
**注意**是合法移动命令后指定多个点。 向这些点绘制一条直线，就像你指定了直线命令一样。 但是这不是建议的样式；请改为使用专门的直线命令。
...
在 Blend for Microsoft Visual Studio2015 中使用**触控笔**工具和其他绘图工具通常将生成[**路径**](/uwp/api/Windows.UI.Xaml.Shapes.Path)对象，具有移动和绘制命令。
