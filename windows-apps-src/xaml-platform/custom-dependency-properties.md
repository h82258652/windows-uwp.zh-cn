...
> [!WARNING]
> 你提供此处可以是任何字符串标识符的名称在编程所选择的语言中有效，但通常希望能够在 XAML 中设置依赖属性。 要在 XAML 中设置，你选择的属性名称必须是有效的 XAML 名称。 有关详细信息，请参阅 [XAML 概述](xaml-overview.md)。
