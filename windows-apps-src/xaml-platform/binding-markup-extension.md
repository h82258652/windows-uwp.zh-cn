...
**注意**有关使用数据的一般信息与 **{Binding}** （和 **{x: Bind}** 和 **{Binding}** 之间的全方位比较），在应用中的绑定，请参阅[深入了解数据绑定](https://msdn.microsoft.com/library/windows/apps/mt210946)。
...
**注意**如果要将标记从 **{x: Bind}** 转换为 **{Binding}**，则应注意差异处于默认**模式**属性值。
