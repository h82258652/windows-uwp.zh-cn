...
> **请注意**手机使用的由于 SD 卡已格式化为 FAT32 文件系统，32 GB 的最大大小。
...
**请注意**此命令将删除所有网络设备，而不仅仅是与模拟器相关联。 当计算机再次启动时，将自动发现所有硬件网络设备。
 
...
> **请注意**XDECleanup.exe 删除所有仿真器特定的 HYPER-V Vm，并且它还将都删除任何 VM 检查点或已保存的状态。
