...
#### DecodePixelWidth 或 DecodePixelHeight 设置为大于图像将在屏幕上显示的大小。 
...
## 辅助功能：具有相同 Controltype 的 UIA 元素不应具有相同的名称。
