...
应用管理器提供安装/卸载和管理功能的应用程序包和捆绑在主机设备上。

![设备门户的应用管理器页面](images/device-portal/wdp-apps.png)
...
4.  查看各个框内，如果你想要安装可选的框架包以及应用安装。 如果你有多个依赖项，请分别添加每一个。     
...
网络页面管理设备上的网络连接。 除非你连接到 Device Portal 通过 USB，更改这些设置将可能断开连接你与 Device Portal。
