...
> **请注意**应非常小心时将缓冲区大小设置大于约 80 KB，这可能导致垃圾回收器堆上产生碎片 （请参阅[改进垃圾回收性能](improve-garbage-collection-performance.md)）。 以下代码示例创建具有 81,920 个字节缓冲区的托管流适配器。
