...
ms.locfileid: "66359751"
---
# <a name="windows-app-certification-kit"></a>Windows 应用认证工具包



若要获取您的应用程序[Windows 认证](https://msdn.microsoft.com/windows/desktop/jj134964.aspx)或为其准备好[发布到 Microsoft Store](https://docs.microsoft.com/windows/uwp/publish/app-submissions)，应验证并进行本地测试第一次。 本主题说明如何安装和运行[Windows 应用认证工具包](https://go.microsoft.com/fwlink/p/?LinkID=309666)以确保您的应用程序的安全和高效。
...
**请注意**  如果使用 Visual Studio，创建你的应用程序包时，可以运行 Windows 应用认证工具包。 请参阅[打包 UWP 应用](https://docs.microsoft.com/windows/uwp/packaging/packaging-uwp-apps)以了解操作方法。
...
执行测试的计算机的特性会影响测试结果。 若要确定是否符合应用的性能[Microsoft Store 策略](https://docs.microsoft.com/legal/windows/agreements/store-policies)，我们建议你测试应用的低功率计算机上，如 Intel Atom 处理器基于计算机屏幕分辨率为 1366x768 （或更高版本）和旋转硬盘驱动器 （而不是固态硬盘）。

随着低能耗计算机的发展，其性能特征可能会随时间的推移而改变。 请参阅最新[Microsoft Store 策略](https://docs.microsoft.com/legal/windows/agreements/store-policies)和测试应用程序与 Windows 应用认证工具包，以确保您的应用程序是否符合最新的性能要求的最新版本。
