...
适用于 Windows 桌面桥应用的可选测试仅供参考，不将用于在 Microsoft 应用商店载入过程中评估你的应用。 我们建议调查这些测试结果以生成质量更好的应用。 应用商店载入的整体通过/失败条件取决于必需测试，而不是这些可选测试。
...
**更正操作**  
若要解决此问题，适用于 UWP 应用使用[必应地图 SDK](https://go.microsoft.com/fwlink/p/?linkid=614880)的最新版本。
