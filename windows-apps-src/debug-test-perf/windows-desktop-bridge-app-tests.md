...
description: 使用桌面桥的内置测试来确保对桌面应用程序进行了优化其转换为 UWP 应用。
ms.date: 12/18/2017
ms.topic: article
...
### <a name="1-digitally-signed-file-test"></a>1.数字签名文件测试 
**背景**  
...
### <a name="2-file-association-verbs"></a>2.文件关联的谓词 
**背景**  
...
### <a name="4-package-sanity-test"></a>4.包完好性测试
...
### <a name="1-app-capabilities-test-special-use-capabilities"></a>1.应用程序功能测试 （特殊用法功能）
...
### <a name="2-app-manifest-resources-tests"></a>2.应用程序清单资源测试 
...
### <a name="3-package-compliance-tests"></a>3.包法规遵从性测试
...
**测试详细信息**  
此测试检查应用中的所有 UWP 组件：
* 验证应用包中的每个托管二进制文件，不会通过检查二进制文件的导入地址表不支持开发 UWP 应用的 Win32 API 有依赖关系。
...
**测试详细信息**  
应用无法请求管理员提升或 UIAccess 每个 Microsoft Store 策略。 不支持提升的安全权限。 
...
**纠正措施**  
若要更正此问题，请使用最新版本[Bing Maps SDK](https://go.microsoft.com/fwlink/p/?linkid=614880)适用于 UWP 应用。
