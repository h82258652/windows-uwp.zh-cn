...
![字距调整和字距之间的差异](images/kerning-tracking.png)  
  ...
  <div class="side-by-side-content-right">
![单词和字母间距之间的差异。](images/word-letter.png) 
  </div>
</div>
</div>
...
<div class="uwpd-image-with-caption">
    ...
    <div>所有尺寸都以有效像素为单位。 有关详细信息，请参阅 [UWP 应用设计简介](../basics/design-and-ui-intro.md)。</div>
</div>
...
若要在字体渐变之外创建其他层次结构，请将次要文字的不透明度设置为 60%。 在[“主题调色板”](color.md#themes)中，可使用 BaseMedium。 主要文字的不透明度应始终为 100% 或 BaseHigh。
