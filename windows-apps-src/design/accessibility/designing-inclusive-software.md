...
了解如何改进适用于 Windows 10 的通用 Windows 平台 (UWP) 应用的非独占设计。  以辅助功能思维设计和生成非独占软件。
...
**认为通用**:我们重点介绍什么统一了人-人动机、 关系和功能。 这促使我们思考我们的工作所产生的更广泛的社会影响。 从而创造出包含可让所有人参与的多样方法的体验。

**使其个性化**:接下来，我们挑战自我创建情感的连接。 人与人的交互可以激发出更好的人与技术的交互。 某个人的独特情况可以为所有人改进一项设计。 从而创造出感觉像是为某一个人创造的体验。

**简单地说**:我们首先确保一致的简单性。 只需减少繁杂，就能让人们知道下一步的行动。 启发他们前进到干净、明亮、开放的空间中。 从而创造出真实而永恒的体验。

**创建兴致勃勃**:想知道和发现，调用它很不一般吧体验。 有时它很神奇。 有时它的细节又恰到好处。 我们将这些时刻设计得感觉像是令人愉悦的节奏变化。 从而创造出具有动力和流动感觉的体验。
...
由 Microsoft 委托并由 Forrester Research 执行的 2003-2004 研究发现美国超过一半 (57%) 的年龄在 18 到 64 岁之间的计算机用户能够从辅助技术中受益。 其中大部分用户不会将自己视为残障或受损人士，但表示在使用计算机时有某些任务相关的困难或障碍。 Forrester (2003) 还会发现以下数量的具有这些特定问题的用户：一个在四个体验 visual 困难。 四分之一用户的手腕或手有伤痛。 五分之一用户有听力障碍。  
