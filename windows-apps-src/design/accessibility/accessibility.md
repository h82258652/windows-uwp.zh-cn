...
ms.locfileid: "70076365"
---
# <a name="accessibility"></a>可访问性  

辅助功能与构建体验相关, 使你的通用 Windows 平台 (UWP) 应用程序可供使用各种环境中的技术的人员使用, 并为 UI 提供各种需求和体验。 对于某些情况，辅助功能要求由法律强制实施。 但是，无论法律是否有规定，最好都解决辅助功能问题，以尽可能扩大应用的受众范围。
