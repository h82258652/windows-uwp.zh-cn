...
> [!NOTE]
> 内部逻辑[ **StackPanel** ](https://msdn.microsoft.com/library/windows/apps/br209635)也具有此行为：**StackPanel**无限维度将值传递给[**度量值**](https://msdn.microsoft.com/library/windows/apps/br208952)对子对象，指示没有对方向维度中的子对象没有约束。 **StackPanel** 通常动态调整自身大小，以使在该维度中增长的堆栈容纳所有子元素。
