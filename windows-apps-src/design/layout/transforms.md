...
title: 转换概述
description: 了解如何在 Windows 运行时 & 中使用转换 \#160;API，通过更改 UI 中元素的相对坐标系统。
ms.date: 02/08/2017
ms.topic: article
...
-   [**System.windows.media.translatetransform.x**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TranslateTransform)：通过设置[**x**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.x)和[**y**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.y)的值来转换 x-y 空间中的元素。
-   [**System.windows.media.scaletransform>** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ScaleTransform)：通过设置[**system.windows.media.rotatetransform.centerx**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centerx)、 [**system.windows.media.rotatetransform.centery**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centery)、 [**ScaleX**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scalex)和[**system.windows.media.scaletransform.scaley**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scaleyproperty)的值，基于中心点缩放变换。
-   [**System.windows.media.rotatetransform>** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.RotateTransform)：通过设置[**Angle**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.angle)、 [**system.windows.media.rotatetransform.centerx**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centerx)和[**system.windows.media.rotatetransform.centery**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centery)的值，在 x-y 空间中旋转。
-   [**SkewTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SkewTransform)：通过设置[**system.windows.media.skewtransform.anglex**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.anglex)、 [**system.windows.media.skewtransform.angley**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.angley)、 [**system.windows.media.rotatetransform.centerx**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.centerx)和[**system.windows.media.rotatetransform.centery**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centeryproperty)的值，在 x-y 空间中倾斜或 shears。
...
**迁移说明：** Windows Presentation Foundation （WPF）具有在布局处理过程之前应用了转换的**system.windows.frameworkelement.layouttransform**属性。 但 Windows 运行时 XAML 不支持 **LayoutTransform** 属性。 （Microsoft Silverlight 也没有此属性。）

## <a name="span-idapplying_a_transform_to_a_ui_elementspanspan-idapplying_a_transform_to_a_ui_elementspanspan-idapplying_a_transform_to_a_ui_elementspanapplying-a-transform-to-a-ui-element"></a><span id="Applying_a_transform_to_a_UI_element"></span><span id="applying_a_transform_to_a_ui_element"></span><span id="APPLYING_A_TRANSFORM_TO_A_UI_ELEMENT"></span>将转换应用于 UI 元素
...
-   [**Brush**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.transform)、 [**RelativeTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.relativetransform)：这会影响[**画笔**](/uwp/api/Windows.UI.Xaml.Media.Brush)如何在应用**画笔**的区域中使用坐标空间来设置视觉对象属性，如 foregrounds 和背景。 虽然这些转换与最常用的画笔不相关（它们通常使用 [**SolidColorBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SolidColorBrush) 设置纯色），但在使用 [**ImageBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ImageBrush) 或 [**LinearGradientBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.LinearGradientBrush) 绘制区域时可能偶尔有用。
-   [**Geometry**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.geometry.transform)：在使用路径的几何图形之前，可以使用此属性将转换应用于几何图形[ **。数据**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.shapes.path.data)属性值。

## <a name="span-idanimating_a_transformspanspan-idanimating_a_transformspanspan-idanimating_a_transformspananimating-a-transform"></a><span id="Animating_a_transform"></span><span id="animating_a_transform"></span><span id="ANIMATING_A_TRANSFORM"></span>对转换进行动画处理

[**转换**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Transform)对象可以进行动画处理。 若要创建 **Transform** 动画，将兼容类型的动画应用到要创建动画的属性。 这通常意味着你使用 [**DoubleAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.DoubleAnimation) 或 [**DoubleAnimationUsingKeyFrames**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.doubleanimationusingkeyframes) 对象定义动画，因为所有转换属性都属于 [**Double**](https://docs.microsoft.com/dotnet/api/system.double) 类型。 即使它们的持续时间不为零，对用于 [**UIElement.RenderTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.rendertransform) 值的转换产生影响的动画也不视为从属动画。 有关从属动画的详细信息，请参阅[情节提要动画](/windows/uwp/design/motion/storyboarded-animations)。
...
## <a name="span-iddescribing_a_transform_mathematicallyspanspan-iddescribing_a_transform_mathematicallyspanspan-iddescribing_a_transform_mathematicallyspandescribing-a-transform-mathematically"></a><span id="Describing_a_transform_mathematically"></span><span id="describing_a_transform_mathematically"></span><span id="DESCRIBING_A_TRANSFORM_MATHEMATICALLY"></span>数学描述转换
...
## <a name="span-id3-d_transformsspanspan-id3-d_transformsspanspan-id3-d_transformsspan3-d-transforms"></a><span id="3-D_transforms"></span><span id="3-d_transforms"></span><span id="3-D_TRANSFORMS"></span>三维转换
...
* [适用于 XAML UI 的三维透视效果](3-d-perspective-effects.md)
