...
阴影是一种方法识别提升。 当存在时提升对象上方的光时，阴影上没有下面的图面。 更高版本的对象、 更大和柔和变得阴影。 请注意，无需具有阴影提升的对象，但阴影执行指示提升。
...
ThemeShadow 类型可应用于任何 XAML 元素绘制阴影相应地具体取决于 x、 y、 z 坐标。 对于其他环境规范还会自动调整 ThemeShadow:
