...
大多数鼠标输入都可以通过所有[**UIElement**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.UIElement)对象支持的常见路由输入事件进行处理。 这些问题包括：
...
**范例**请参阅[BasicInput 示例](https://go.microsoft.com/fwlink/p/?LinkID=620302)。
