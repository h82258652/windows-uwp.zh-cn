...
| 属性 | 在任务栏的搜索框中键入 | 必需 |描述 |
|---|---|---|---|
| **映像** | IList<[TileBasicImage](#tilebasicimage)> | true | 将以圆圈形式滚动的图像。 |
...
| 属性 | 在任务栏的搜索框中键入 | 必需 |描述 |
|---|---|---|---|
| **映像** | IList<[TileBasicImage](#tilebasicimage)> | true | 最多可提供 12 个图像（移动设备最多显示 9 个），这些图像将用于幻灯片放映。 如果添加的图像超过 12 个，将引发异常。 |
