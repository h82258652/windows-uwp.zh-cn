...
通知镜像可为开发人员提供两大好处：镜像通知可使更多用户参与服务，也可以帮助用户发现 Windows 应用商店桌面应用！ 用户甚至可能不知道有出色的 UWP 应用可用于他们的 Windows 10 桌面。 当用户从手机接收到镜像通知时，用户可以单击 Toast 通知跳转到 Windows 应用商店，安装 UWP 桌面应用。
