...
在你的应用清单中，除常规图标外，还应指定备用形式的未着色图标。 有关详细信息，请参阅[磁贴和图标资源指南](./tiles-and-notifications/app-assets.md)。 要指定的图标在文章的[资源类型](./tiles-and-notifications/app-assets.md#asset-types)部分记录为“未着色的目标大小列表资源”。
