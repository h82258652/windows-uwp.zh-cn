...
<td>
    <p>如果有<strong style="font-weight: semi-bold">XAML 控件库</strong>应用程序安装，请单击此处<a href="xamlcontrolsgallery:/category/Motion">打开应用并在操作中看到运动</a>。</p>
    <ul>
