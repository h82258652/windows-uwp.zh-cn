...
*模式* 是修改控件或组合多个控件来创造新内容的一种诀窍。 例如，[大纲/细节](master-details.md)模式是，你可以使用[SplitView](split-view.md)控件，用于应用导航的方法。 同样，你可以自定义[NavigationView](navigationview.md)控件实现选项卡模式的模板。
