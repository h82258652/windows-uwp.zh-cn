...
若要修改上下文菜单中显示的命令，请处理 [ContextMenuOpening](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox.contextmenuopening) 事件。 有关此内容的示例，请参阅 [ContextMenu 示例](https://code.msdn.microsoft.com/windowsapps/Context-menu-sample-40840351)的方案 2。 有关设计信息，请参阅上下文菜单指南。
