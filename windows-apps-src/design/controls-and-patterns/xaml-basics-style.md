...
ms.locfileid: "1635775"
---
# <a name="create-custom-styles"></a>创建自定义样式
...
若要定义样式，你可以将 [Style](https://msdn.microsoft.com/library/windows/apps/br208849) 元素添加到某个元素的 [Resources](https://docs.microsoft.com/en-us/uwp/api/windows.ui.xaml.frameworkelement#Windows_UI_Xaml_FrameworkElement_Resources) 属性中，该元素包含你要设置样式的控件。  如果你将样式添加到 **Page.Resources** 属性中，则整个页面将可以使用你的样式。 如果你在 App.xaml 文件内将你的样式添加到 **Application.Resources** 中，则整个应用将可以使用该样式。
