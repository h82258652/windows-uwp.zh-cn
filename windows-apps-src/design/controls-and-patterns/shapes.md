...
**请注意**你可以明确设置相同的起点和在[**点**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.shapes.polyline.points.aspx)中的终结点设置的[**折线**](/uwp/api/Windows.UI.Xaml.Shapes.Polyline)，但是，在此情况下你可能具有[**多边形**](/uwp/api/Windows.UI.Xaml.Shapes.Polygon)改为。
