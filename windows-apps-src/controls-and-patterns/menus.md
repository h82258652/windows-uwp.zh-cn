...
<li>通过左键单击（或等效操作，例如用手指点击）进行调用。</li><li>通过 [Flyout](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.button.flyout.aspx) 或 [FlyoutBase.AttachedFlyout](https://msdn.microsoft.com/en-us/library/windows/apps/windows.ui.xaml.controls.primitives.flyoutbase.attachedflyout.aspx) 属性与元素相关联。</li>
</ul>
</div>
...
不必为每个菜单项提供图标，特别是菜单很长或者命令没有标准可视化时。 加密图标没有帮助，创建可视的待筛选邮件，并阻止用户关注重要菜单项。
