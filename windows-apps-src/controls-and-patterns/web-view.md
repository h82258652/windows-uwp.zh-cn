...
> **注意** 在移动设备的 UI 线程上承载内容时可能存在性能问题，因此确保在更改 DefaultExecutionMode 时，在所有目标设备上进行测试。
...
-   如果 Web 视图的外观与应用其他部分有差异，请考虑使用替代控件或方法完成相关任务。 如果你的 Web 视图与应用的其他部分相匹配，用户会将其视作一个整体无缝体验。
