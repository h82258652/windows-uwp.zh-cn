...
-   [**Text 属性**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.controls.textbox.text.aspx)
...
有两个可用于控制 TextBox 是否在多行上显示文本的属性。 通常同时设置这两个属性来创建多行文本框。
...
有关详细信息和示例，请参阅[使用输入范围更改触摸键盘]()和属性文档。
