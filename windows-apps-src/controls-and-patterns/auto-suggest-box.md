...
若要查看 AutoSuggestBox 的完整工作示例，请参阅 [AutoSuggestBox 示例](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/XamlAutoSuggestBox)和 [XAML UI 基本示例](http://go.microsoft.com/fwlink/p/?LinkId=619992)。
...
<table>
<tr>
<th>垂直间距</th><td>为垂直间距使用非拉丁字符以确保非拉丁脚本（包括数字）能够正确显示。</td>
</tr>
<tr>
<th>滚动</th><td>选择自动建议文本后，用户应该能够滚动到字符串末尾。</td>
</tr>
</table>
</div>
