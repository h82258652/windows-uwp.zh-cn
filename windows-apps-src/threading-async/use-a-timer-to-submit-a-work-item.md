...
-   [**Windows UI 命名空间**](https://docs.microsoft.com/uwp/api/Windows.UI.Core)
-   [**System.web 命名空间**](https://docs.microsoft.com/uwp/api/Windows.System.Threading)
...
> **请注意**  可以使用[**RUNASYNC**](https://docs.microsoft.com/uwp/api/windows.ui.core.coredispatcher.runasync)来访问 UI，并显示工作项的进度。
...
如需演示工作项、计时器工作项和定期工作项的完整代码示例，请参阅[线程池示例](https://code.msdn.microsoft.com/windowsapps/Pool-Sample-5aa60454)。 此代码示例最初是为 Windows 8.1 编写的，但代码可以在 Windows 10 中重复使用。
