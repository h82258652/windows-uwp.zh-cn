...
若要启动该 Windows 映射应用程序从您的应用程序，请调用[ **LaunchUriAsync** ](https://docs.microsoft.com/uwp/api/windows.system.launcher.launchuriasync)方法替换**bing maps:** ， **ms-到驱动器：** ，或**ms-到审核：** URI。 以下示例启动前一个示例中相同的 URI。 有关通过 URI 启动应用的详细信息，请参阅[启动 URI 的默认应用](launch-default-app.md)。
...
| bingmaps:?collection=point.40.726966\_-74.006076\_Some%255FBusiness        | 使用名为一些的点显示地图\_业务 （在拉斯维加斯举行）。                                                                                                                               |
...
| bingmaps:?collection=point.40.726966\_-74.006076\_Fake%255FBusiness%255Fwith%255FUnderscore                                                                        | 使用名为虚设图钉显示纽约\_业务\_与\_下划线。                                                  |
