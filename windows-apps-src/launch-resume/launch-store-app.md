...
<p>每个应用的应用管理部分中的<a href="https://msdn.microsoft.com/library/windows/apps/mt148561.aspx">应用标识</a>页面上，可以在<a href="https://partner.microsoft.com/dashboard">合作伙伴中心</a>中找到这些值。</p>
</td>
<td>
应用商店 ID <p>（建议）</p>
</td>
