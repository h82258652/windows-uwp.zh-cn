---
author: TylerMSFT
title: 移植为进程内后台任务的进程外后台任务
description: 移植到在前台应用进程中运行的进程内后台任务的进程外后台任务。
ms.author: twhitney
ms.date: 09/19/2018
ms.topic: article
ms.prod: windows
...
ms.locfileid: "4207949"
---
# <a name="port-an-out-of-process-background-task-to-an-in-process-background-task"></a>移植为进程内后台任务的进程外后台任务
