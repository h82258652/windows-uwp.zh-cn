...
[可选包和相关的一组创作](https://docs.microsoft.com/windows/uwp/packaging/optional-packages)  
[使用资产包和包折叠进行开发](../packaging/package-folding.md)  
[UWP 应用程序流式处理安装](https://docs.microsoft.com/windows/uwp/packaging/streaming-install)  
