...
author: QuinnRadich
title: 启动屏幕截取
description: 本主题介绍了 ms screenclip 和 ms screensketch URI 方案。 你的应用可以使用这些 URI 方案来启动截图和 Sketch 应用或打开新的代码段。
ms.author: quradic
ms.date: 8/1/2017
ms.topic: article
...
## <a name="launching-the-snip--sketch-app"></a>启动截图和 Sketch 应用

**Ms screensketch:** URI 允许你以编程方式启动截图和 Sketch 的应用，并打开该批注的应用中的特定的图像。
...
下面的示例调用[LaunchUriAsync](https://docs.microsoft.com/uwp/api/Windows.System.Launcher#Windows_System_Launcher_LaunchUriAsync_Windows_Foundation_Uri_)以从用户的应用发送到截图和 Sketch 的图像。
