...
6. 在“初始屏幕”部分的“背景色”字段中，将背景色设置为与初始屏幕图像一起显示。 可以输入的一种颜色名称或\#和一种颜色的十六进制值。 有关可用颜色的名称列表，请参阅 [**SplashScreen 元素**](https://msdn.microsoft.com/library/windows/apps/br211467)。 你也可以为初始屏幕设置背景色。 如果未指定一种颜色的 UWP 应用，初始屏幕背景色将默认为浅灰色 (十六进制值\#464646)。 这与默认的“磁贴”背景色相同（请参阅“可视资源”选项卡的“磁贴图像和徽标”部分中的“背景色”字段）。 如果你未为 Windows Phone 指定颜色，或将其设置为“透明”，则初始屏幕背景色将为透明。
...
* [包清单架构参考：初始屏幕元素](https://msdn.microsoft.com/library/windows/apps/br211467)
