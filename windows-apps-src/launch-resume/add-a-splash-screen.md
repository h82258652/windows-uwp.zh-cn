...
2.  在**“解决方案资源管理器”**中，打开“Package.appxmanifest”文件。 也可以通过选择**“项目”**>**“应用商店”**>**“编辑应用清单”**，从菜单栏中打开此文件。
...
4.  若要选择适用于 UWP 应用的新的初始屏幕图像，请按下在“比例资源”****下的“1240 x 600 像素”****标签旁边显示的带省略号的按钮。 选择你要用于初始屏幕图像的 1240 x 600 像素图像（.png、.jpg 或 .jpeg）。

    **重要提示** 所选初始屏幕图像必须为使用 1 倍比例系数的 620 x 300 像素。 此外，在设计你的初始屏幕时，请注意它比屏幕小，并且居中。 它不像 Windows Phone 应用商店应用的初始屏幕一样会填满屏幕。

     

5.  要选择适用于 Windows 应用商店应用的新的初始屏幕图像，请按下在“比例资产”****下的“1152 x 1920 像素”****标签旁边显示的带省略号的按钮。 选择你要用于初始屏幕图像的 1152 x 1920 像素图像（.png、.jpg 或 .jpeg）。
