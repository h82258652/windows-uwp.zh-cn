# [通用 Windows 平台入门](https://dev.windows.com/en-us/getstarted)
...
# [设计和 UI](https://dev.windows.com/en-us/design)
## [布局](https://dev.windows.com/design/layout)
...
## [样式](https://dev.windows.com/design/style)
### [颜色](style/color.md)
### [图标](style/icons.md)
### [动作](style/motion.md)
### [声音](style/sound.md)
### [版式](style/typography.md)
### [设置控件的样式](controls-and-patterns/styling-controls.md)
## [控件和模式](https://dev.windows.com/design/controls-patterns)
...
## [输入和设备](https://dev.windows.com/design/inputs-devices)
...
#### [游戏板和远程控制交互](input-and-devices/gamepad-and-remote-interactions.md)
...
## [可用性](https://dev.windows.com/design/usability)
...
## [Microsoft 设计语言](https://dev.windows.com/design/microsoft-design-language)
## [下载](https://dev.windows.com/design/assets)
# [开发 Windows 应用](http://dev.windows.com/develop)
...
###### [如何：将简单的 OpenGL ES 2.0 呈现器移植到 Direct3D 11.1](gaming/port-a-simple-opengl-es-2-0-renderer-to-directx-11-1.md)
...
##### [在开发人员中心仪表板中管理实验](monetize/manage-your-experiment.md)
...
#### [使用配套设备进行解锁](security/companion-device-unlock.md)
...
## [服务](https://dev.windows.com/en-us/develop/microsoft-services)
...
# [发布 Windows 应用](https://dev.windows.com/en-us/publish)
