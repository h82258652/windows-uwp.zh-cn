...
#### [创建和注册进程外后台任务](launch-resume/create-and-register-an-outofproc-background-task.md)
...
### [与远程应用服务通信](launch-resume/communicate-with-a-remote-app-service.md)
### [将应用服务转换为在与其主机应用相同的进程中运行的服务](launch-resume/convert-app-service-in-process.md)
...
### [Windows10 版本 1607 中的 API 新增内容](whats-new/windows-10-version-1607-api-diff.md)
...
### [Windows10 版本 1507 中的新增功能](whats-new/windows-10-version-1507.md)
## [Windows8.x 指南](https://msdn.microsoft.com/library/windows/apps/mt244353.aspx)
...
### [你的应用如何显示在面向 Windows10 客户的应用商店中](publish/how-your-app-appears-in-the-store-for-windows-10-customers.md)
