...
# [设计和 UI](https://developer.microsoft.com/windows/apps/design)
## [布局](layout/index.md)
...
#### [蓝牙低功耗 (LE) 广告](devices-sensors/ble-beacon.md)
...
###### [调整磁贴池的大小](graphics-concepts/tile-pool-resizing.md)
...
#### [在仪表板中创建项目和定义远程变量](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
#### [针对实验为你的应用编码](monetize/code-your-experiment-in-your-app.md)
...
### [配置应用以接收开发人员中心推送通知](monetize/configure-your-app-to-receive-dev-center-notifications.md)
...
##### [将应用更新到最新的 Microsoft Advertising 库](monetize/update-your-app-to-the-latest-advertising-libraries.md)
##### [针对 UWP 应用从 AdMediatorControl 迁移到 AdControl](monetize/migrate-from-admediatorcontrol-to-adcontrol.md)
...
##### [使用 HTML 5 和 JavaScript 向视频内容添加广告](monetize/add-advertisements-to-video-content.md)
...
#### [回复评价](monetize/respond-to-reviews-using-windows-store-services.md)
##### [获取应用评价的回复信息](monetize/get-response-info-for-app-reviews.md)
##### [提交对应用评价的回复](monetize/submit-responses-to-app-reviews.md)
#### [投放广告活动](monetize/run-ad-campaigns-using-windows-store-services.md)
##### [管理广告活动](monetize/manage-ad-campaigns.md)
##### [管理广告活动的投放渠道](monetize/manage-delivery-lines-for-ad-campaigns.md)
##### [管理广告活动的目标市场配置文件](monetize/manage-targeting-profiles-for-ad-campaigns.md)
##### [管理广告活动的创意](monetize/manage-creatives-for-ad-campaigns.md)
...
###### [获取应用提交的软件包推出信息](monetize/get-package-rollout-info-for-an-app-submission.md)
###### [更新应用提交的软件包推出百分比](monetize/update-the-package-rollout-percentage-for-an-app-submission.md)
###### [终止应用提交的软件包推出](monetize/halt-the-package-rollout-for-an-app-submission.md)
###### [完成应用提交的软件包推出](monetize/finalize-the-package-rollout-for-an-app-submission.md)
...
###### [获取软件包外部测试版提交的软件包推出信息](monetize/get-package-rollout-info-for-a-flight-submission.md)
###### [更新软件包外部测试版提交的软件包推出百分比](monetize/update-the-package-rollout-percentage-for-a-flight-submission.md)
###### [终止软件包外部测试版提交的软件包推出](monetize/halt-the-package-rollout-for-a-flight-submission.md)
###### [完成软件包外部测试版提交的软件包推出](monetize/finalize-the-package-rollout-for-a-flight-submission.md)
##### [Windows 应用商店提交 API 的代码示例](monetize/code-examples-for-the-windows-store-submission-api.md)
...
#### [管理服务中的产品权益](monetize/view-and-grant-products-from-a-service.md)
...
#### [准备应用以使用桌面桥转换](porting/desktop-to-uwp-prepare.md)
#### [Desktop App Converter](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [使用桌面桥手动将你的应用转换到 UWP](porting/desktop-to-uwp-manual-conversion.md)
#### [桌面桥应用扩展](porting/desktop-to-uwp-extensions.md)
#### [使用桌面桥转换的应用支持的 UWP API](porting/desktop-to-uwp-supported-api.md)
#### [适用于使用 Visual Studio 创建的 .NET 桌面应用的桌面桥打包指南](porting/desktop-to-uwp-packaging-dot-net.md)
#### [调试使用桌面桥转换的应用](porting/desktop-to-uwp-debug.md)
#### [对使用桌面桥转换的应用签名](porting/desktop-to-uwp-signing.md)
#### [分配使用桌面桥转换的应用](porting/desktop-to-uwp-distribute.md)
#### [在桌面桥幕后](porting/desktop-to-uwp-behind-the-scenes.md)
#### [桌面桥的已知问题](porting/desktop-to-uwp-known-issues.md)
...
## [面向开发人员的 Windows 10 中的新增功能](whats-new/windows-10-creators-preview.md)
### [Windows 10 版本 1607 中的新增功能](whats-new/windows-10-version-1607.md)
...
### [为帐户用户设置自定义权限](publish/set-custom-permissions-for-account-users.md)
...
### [设置加载项产品 ID 和产品类型](publish/set-your-add-on-product-id.md)
...
### [渠道和转换报告](publish/channels-and-conversions-report.md)
### [广告中介报告](publish/ad-mediation-report.md)
### [广告效果报告](publish/advertising-performance-report.md)
### [联盟效果报告](publish/affiliates-performance-report.md)
### [“推广你的应用”报告](publish/promote-your-app-report.md)
...
### [为您的应用创建广告活动](publish/create-an-ad-campaign-for-your-app.md)
...
### [将目标推送通知发送到应用客户](publish/send-push-notifications-to-your-apps-customers.md)
