...
#### [获取应用和加载项信息](monetize/get-info-for-apps-and-add-ons.md)
#### [购买应用或加载项](monetize/purchase-an-app-or-add-on.md)
#### [获取应用的许可证信息](monetize/get-license-info-for-your-app.md)
#### [实现应用的试用版](monetize/implement-a-trial-version-of-your-app.md)
#### [管理可消耗的加载项](monetize/manage-consumable-add-ons.md)
#### [Windows 10 版本 1607 之前的应用内购买和试用](monetize/in-app-purchases-and-trials-before-windows-10-version-1607.md)
