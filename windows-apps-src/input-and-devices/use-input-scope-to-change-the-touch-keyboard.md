...
4.  将 [**InputScopeName**](https://msdn.microsoft.com/library/windows/apps/hh702027) 对象的 [**NameValue**](https://msdn.microsoft.com/library/windows/apps/hh702032) 属性设置为 [**InputScopeNameValue**](https://msdn.microsoft.com/library/windows/apps/hh702028) 枚举的值。

    ```csharp
    scopeName.NameValue = InputScopeNameValue.TelephoneNumber;
    ```

5.  将 [**InputScopeName**](https://msdn.microsoft.com/library/windows/apps/hh702027) 对象添加到 [**InputScope**](https://msdn.microsoft.com/library/windows/apps/hh702025) 对象的 [**Names**](https://msdn.microsoft.com/library/windows/apps/hh702034) 集合。
