...
> 注意：本主题重点介绍 Windows Ink 平台。 有关常规指针输入处理（类似于鼠标、触摸和触摸板），请参阅[处理指针输入](handle-pointer-input.md)。
...
<tbody>
<tr class="odd">
<td align="left"><p>[识别笔划墨迹](convert-ink-to-text.md)</p></td>
<td align="left"><p>使用手写识别将笔划墨迹转换为文本，或使用自定义识别转换为形状。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[存储和检索笔划墨迹](save-and-load-ink.md)</p></td>
