...
## [迁移旧版资源](../app-resources/using-mrt-for-converted-desktop-apps-and-games.md)
...
## [C++/WinRT 简介](../cpp-and-winrt-apis/intro-to-using-cpp-with-winrt.md)
## [C++/WinRT 常见问题](../cpp-and-winrt-apis/faq.md)
## [C++/WinRT 中的字符串处理](../cpp-and-winrt-apis/strings.md)
## [标准 C++ 数据类型和 C++/WinRT](../cpp-and-winrt-apis/std-cpp-data-types.md)
## [通过 C++/WinRT 将标量值装箱到 IInspectable 和从 IInspectable 取消标量值装箱](../cpp-and-winrt-apis/boxing.md)
## [接口：如何在 C++/WinRT 中实现](../cpp-and-winrt-apis/implement-an-interface.md)
## [C++/WinRT 运行时类的实现和投影类型](../cpp-and-winrt-apis/ctors-runtimeclass-activation.md)
## [事件：如何在 C++/WinRT 中创作和处理](../cpp-and-winrt-apis/events-author-handle.md)
## [通过 C++/WinRT 的并发和异步操作](../cpp-and-winrt-apis/concurrency.md)
## [XAML 控制台：绑定到 C++/WinRT 属性](../cpp-and-winrt-apis/binding-property.md)
## [XAML 项目控件：绑定到 C++/WinRT 集合](../cpp-and-winrt-apis/binding-collection.md)
## [C++/WinRT 问题疑难解答](../cpp-and-winrt-apis/troubleshooting.md)
...
# [开发教育应用](../apps-for-education/index.md)
...
# [盈利、参与度和 Store 服务](../monetize/index.md)
...
## [发送请求到 Store](../monetize/send-requests-to-the-store.md)
...
# [API 参考](https://docs.microsoft.com/uwp/)
