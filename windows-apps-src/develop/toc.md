...
## [C++/WinRT 入门](../cpp-and-winrt-apis/get-started.md)
## [常见问题](../cpp-and-winrt-apis/faq.md)
## [疑难解答](../cpp-and-winrt-apis/troubleshooting.md)
## [照片编辑器 C++/WinRT 示例应用程序](../cpp-and-winrt-apis/photo-editor-sample.md)
...
## [通过 C++/WinRT 使用 API](../cpp-and-winrt-apis/consume-apis.md)
## [使用 C++/WinRT 创作 API](../cpp-and-winrt-apis/author-apis.md)
## [C++/WinRT 的错误处理](../cpp-and-winrt-apis/error-handling.md)
## [使用委托处理事件](../cpp-and-winrt-apis/handle-events.md)
...
#### [使用条形码扫描仪](../devices-sensors/pos-barcodescanner-get-started.md)
...
## [WPF 和 Windows 窗体应用程序中的 UWP 控件](../xaml-platform/xaml-host-controls.md)
