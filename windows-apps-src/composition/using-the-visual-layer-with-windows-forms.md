...
ms.locfileid: "58174049"
---
# <a name="using-the-visual-layer-with-windows-forms"></a>可视化层中使用 Windows 窗体

可以使用 Windows 运行时组合 Api (也称为[可视化层](visual-layer.md)) 在 Windows 窗体应用程序以创建现代的轻型注册 Windows 10 用户体验。
...
![在正在运行的应用程序 UI](images/interop/wf-comp-interop-app-ui.png)
