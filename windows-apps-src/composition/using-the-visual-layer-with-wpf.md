...
ms.locfileid: "58174072"
---
# <a name="using-the-visual-layer-with-wpf"></a>可视化层中使用 WPF

可以使用 Windows 运行时组合 Api (也称为[可视化层](visual-layer.md)) 在 Windows Presentation Foundation (WPF) 应用程序以创建现代的轻型注册 Windows 10 用户体验。
...
![在正在运行的应用程序 UI](images/interop/wpf-comp-interop-app-ui.png)
