...
有关将画笔与 XAML UI 结合使用的详细信息，请参阅[**画笔**](../graphics/using-brushes.md#xamlcompositionbrushbase)部分。
...
这是前面使用相同 XAML 结构的 C&#35; 代码的 [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx) 等效项。
