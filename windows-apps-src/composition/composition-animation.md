...
- 自定义 – Windows UI 层不仅可以轻松进行美观的 UI，但是使用一系列动画类型，以创建新的和令人惊叹的体验是自定义的渐变
...
| ImplicitAnimations | 这些动画基于触发器并定义独立于核心应用逻辑。 ImplicitAnimations 用于描述如何以及何时动画是作为响应直接属性更改。 |
