...
* 使用代码创建应用代码可检索远程变量值、 使用此数据来更改按钮的背景色并记录视图和转换事件数据返回到合作伙伴中心。
...
若要按照此演练，必须具有合作伙伴中心帐户和中所述，你必须配置你的开发计算机[运行应用实验通过 A / B 测试](run-app-experiments-with-a-b-testing.md)。
...
2. 如果你已拥有你想要用于创建实验的合作伙伴中心中的应用，请在合作伙伴中心中选择该应用。 如果你尚未执行此合作伙伴中心中，[创建新的应用通过保留名称](../publish/create-your-app-by-reserving-a-name.md)中有一个应用，然后在合作伙伴中心中选择该应用。
...
> [!NOTE]
> 一旦激活某个实验时，合作伙伴中心会立即开始从进行检测以数据为你的实验记录的任何应用中收集数据。 但是，可能需要几个小时实验数据，以显示在合作伙伴中心。
