...
|  [在 UWP 应用中显示广告](display-ads-in-your-app.md)    |  使用 UWP 应用中的 [AdControl](https://msdn.microsoft.com/library/windows/apps/microsoft.advertising.winrt.ui.adcontrol.aspx) 或 [InterstitialAd](https://msdn.microsoft.com/library/windows/apps/microsoft.advertising.winrt.ui.interstitialad.aspx) 控件通过显示横幅广告或间隙广告增加收入。<br/><br/>
            **注意**
...
>
            **注意**
            &nbsp;&nbsp;如果已通过 NuGet 安装 SDK 库，除了 **Microsoft Advertising SDK for XAML** 或 **Microsoft Advertising SDK for JavaScript**，项目还将包含 **Microsoft.Services.Store.SDK** 引用。 
            **Microsoft.Services.Store.SDK** 引用表示 NuGet 包（而不是其中的库），并且你可以忽略它。
