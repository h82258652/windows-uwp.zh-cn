---
author: Xansky
description: 在 Microsoft Store 分析 API 中使用此方法，若要下载的 Xbox One 游戏中的错误的 CAB 文件。
...
你可以使用此方法之前，你都必须首先使用[获取 Xbox One 游戏中的错误的详细信息](get-details-for-an-error-in-your-xbox-one-game.md)的方法来检索你想要下载的 CAB 文件的 ID。
...
| 参数        | 类型   |  说明      |  必需  |
|---------------|--------|---------------|------|
| applicationId | 字符串 | 你下载的 CAB 文件的 Xbox One 游戏的产品 ID。 若要获取你的游戏的产品 ID，请导航到 Xbox 开发人员门户 (XDP) 中你的游戏，并从 URL 中检索产品 ID。 或者，如果你从 Windows 开发人员中心分析报告下载运行状况数据，该.tsv 文件中包含的产品 ID。 |  是  |
