...
| deviceModel           | 字符串  | 指定在其发生错误时运行该游戏在 Xbox One 控制台的以下字符串之一。<p/><ul><li><strong>Microsoft Xbox 一个</strong></li><li><strong>Microsoft Xbox 一个 S</strong></li><li><strong>Microsoft Xbox One X</strong></li></ul>  |
