---
author: mcleanbyron
description: "使用 Windows 应用商店分析 API 中的此方法，可获取给定日期范围和其他可选筛选器内某一应用程序的购置漏斗数据。"
title: "获取应用购置漏斗数据"
ms.author: mcleans
ms.date: 08/04/2017
ms.topic: article
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, 应用商店服务, Windows 应用商店分析 API, 购置, 漏斗"
...
使用 Windows 应用商店分析 API 中的此方法，可获取给定日期范围和其他可选筛选器内某一应用程序的购置漏斗数据。 还可以在 Windows 开发人员中心仪表板的[购置报告](../publish/acquisitions-report.md#acquisition-funnel)中获取此信息。
