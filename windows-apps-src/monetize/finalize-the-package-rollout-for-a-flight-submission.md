...
* 在合作伙伴中心中创建应用提交。 你可以执行此操作在合作伙伴中心，或者你可以通过使用[创建应用提交](create-an-app-submission.md)的方法。
* 启用提交的逐步软件包推出。 你可以执行此操作在[合作伙伴中心](../publish/gradual-package-rollout.md)，或者你可以通过[使用 Microsoft Store 提交 API](manage-flight-submissions.md#manage-gradual-package-rollout)。
