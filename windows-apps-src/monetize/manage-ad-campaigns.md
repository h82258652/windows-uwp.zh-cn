...
description: "在 Windows 应用商店促销 API 中使用此方法创建、编辑和获取促销性广告活动。"
title: "管理广告活动"
ms.author: mcleans
ms.date: 02/08/2017
ms.topic: article
...
使用这些方法创建或更新活动时，你通常还需要调用以下一种或多种方法来管理与活动关联的*投放渠道*、*目标市场配置文件*和*创意*。 有关活动与投放渠道、目标市场配置文件和创意之间关系的详细信息，请参阅[使用 Windows 应用商店服务开展广告活动](run-ad-campaigns-using-windows-store-services.md#call-the-windows-store-promotions-api)。
