...
| 0x803F6108   | 无法完成应用内购买，因为应用许可缺少的信息。 当你旁加载你的应用时，会发生此错误。 若要解决此问题，卸载应用，然后从应用商店以刷新应用许可中重新安装它。                                          |
| 0x803F6109   | 指定的数量的剩余余额不仅仅是因为无法完成易耗型加载项的实施情况。        |
...
与[自行安装的程序包更新](../packaging/self-install-package-updates.md)相关的以下错误代码。
...
| 0x803F6204   | 若要下载包更新，因为下载将会发生按流量计费的网络连接，需要进行用户同意。                                             |
