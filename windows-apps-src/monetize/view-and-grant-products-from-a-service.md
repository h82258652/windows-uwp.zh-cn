...
| `http://schemas.microsoft.com/marketplace/2015/08/claims/key/userId`     | 标识服务上下文中的当前用户的用户 ID。 此值与你传递到[用于生成密钥的方法](view-and-grant-products-from-a-service.md#step-4)的可选 *publisherUserId* 参数中的值相同。 |
