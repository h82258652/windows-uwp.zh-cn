...
ms.locfileid: "6462992"
---
# <a name="implement-a-trial-version-of-your-app"></a>实现应用的试用版

如果你为[应用配置为在合作伙伴中心中的免费试用版](../publish/set-app-pricing-and-availability.md#free-trial)，以便客户可以在试用期内免费使用你的应用，则可以吸引客户升级到你的应用的完整版通过排除或在试用期内限制某些功能。 请在开始编码之前确定哪些功能应受到限制，然后确保你的应用只在已购买完整版许可之后才允许这些功能运作。 也可以在客户购买你的应用之前，启用仅在试用期才会出现的某些功能，如横幅或水印。
...
* 你已配置为[免费试用版](https://msdn.microsoft.com/windows/uwp/publish/set-app-pricing-and-availability)没有时间限制的合作伙伴中心中创建应用，并在应用商店中发布此应用。 在测试应用期间，你可以选择将应用配置为在应用商店中隐藏。 有关详细信息，请参阅我们的[测试指南](in-app-purchases-and-trials.md#testing)。
