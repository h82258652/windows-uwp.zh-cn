...
<td align="left">要检索其评分数据的应用的产品 ID。 产品 ID 嵌入应用的一览链接中，该链接在开发人员中心仪表板的 [App identity page](https://msdn.microsoft.com/library/windows/apps/mt148561) 上提供。 产品 ID 的一个示例为 9WZDNCRFJ3Q8。</td>
<td align="left">是</td>
</tr>
<tr class="even">
