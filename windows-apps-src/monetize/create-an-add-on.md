...
|--------|------------------|
| 400  | 请求无效。 |
| 409  | 由于其当前状态下，无法创建加载项或加载项使用的是[当前不受 Microsoft Store 提交 API](create-and-manage-submissions-using-windows-store-services.md#not_supported)的合作伙伴中心功能。 |   
