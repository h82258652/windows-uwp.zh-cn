...
ms.locfileid: "8790425"
---
# <a name="get-insights-data"></a>获取的见解数据

若要获取的见解数据在 Microsoft Store 分析 API 中的此方法与购置、 运行状况和使用情况的应用的指标给定的日期范围和其他可选筛选器内使用。 此信息也是在合作伙伴中心中的[洞察报告](../publish/insights-report.md)中可用。
...
| insightDate                | 字符串 | 我们在其标识特定指标的更改日期。 此日期表示一周中，我们检测到了显著增加结束或减少相对于前的一周的指标。 |
