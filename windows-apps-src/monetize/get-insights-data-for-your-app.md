...
ms.locfileid: "5768246"
---
# <a name="get-insights-data"></a>获取的见解数据

若要获取的见解数据在 Microsoft Store 分析 API 中的此方法与购置、 运行状况和应用的使用情况指标给定的日期范围和其他可选筛选器内使用。 此信息也是在 Windows 开发人员中心仪表板中的[洞察报告](../publish/insights-report.md)中可用。
