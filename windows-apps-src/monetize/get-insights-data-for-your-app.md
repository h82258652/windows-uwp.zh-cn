...
| 参数        | 类型   |  说明      |  必需  
|---------------|--------|---------------|------|
| applicationId | 字符串 | 你要检索的见解数据的应用[商店 ID](in-app-purchases-and-trials.md#store-ids) 。 如果未指定此参数，响应正文将包含注册到帐户的所有应用的见解数据。  |  否  |
...
| 数据类型     | 字符串 | 用于指定此相关的见解描述的常规分析区域的以下字符串之一：<p/><ul><li><strong>购置</strong></li><li><strong>运行状况</strong></li><li><strong>使用情况</strong></li></ul>   |
