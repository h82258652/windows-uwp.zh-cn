...
* [更新应用提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-app-submission)。
* [创建并确认加载项提交](csharp-code-examples-for-the-windows-store-submission-api.md#create-and-commit-add-on-submission)。
* [更新加载项提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-add-on-submission)。
* [更新软件包外部测试版提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-flight-submission)。
...
以下示例实现了一个命令行计划，该计划可调用本文中的其他示例方法演示使用 Windows 应用商店提交 API 的不同方法。
...
本部分提供本文中 Windows 应用商店提交 API 示例使用的帮助程序类。

<span id="clientconfiguration" />
### ClientConfiguration 帮助程序类

以下示例定义了 ```ClientConfiguration``` 类，该类用于将数据传递到每个使用 Windows 应用商店提交 API 的其他示例方法。
...
以下示例定义了 ```IngestionClient``` 类，该类为某些涉及 Windows 应用商店提交 API 的关键任务提供帮助程序方法。
...
以下示例演示了如何[更新应用提交](manage-app-submissions.md)。 此示例使用上述 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 帮助程序类。
...
以下示例演示了如何[创建并确认新加载项提交](manage-add-on-submissions.md)（加载项也称为应用内产品或 IAP）。 此示例使用上述 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 帮助程序类。
...
以下示例演示了如何[更新加载项提交](manage-add-on-submissions.md)（加载项也称为应用内产品或 IAP）。 此示例使用上述 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 帮助程序类。
...
以下示例演示如何[更新全新的软件包外部测试版提交](manage-flight-submissions.md)。 此示例使用上述 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 帮助程序类。
