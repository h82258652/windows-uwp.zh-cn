...
合作伙伴中心的 "[收购" 报告](../publish/acquisitions-report.md#app-page-views-and-conversions-by-channel)中也提供了此信息。
...
| 参数        | 类型   |  说明      |  必需  
|---------------|--------|---------------|------|
| applicationId | 字符串 | 你要检索转换数据的应用的[应用商店 ID](in-app-purchases-and-trials.md#store-ids)。 Store ID 示例：9WZDNCRFJ3Q8。 |  是  |
...
| 值      | 类型   | 说明                  |
|------------|--------|-------------------------------------------------------|
| Value      | array  | 包含聚合应用转换数据的对象数组。 有关每个对象中的数据的详细信息，请参阅以下[转换值](#conversion-values)部分。                                                                                                                      |
