...
author: mcleanbyron
ms.assetid: 
description: "在 Windows 应用商店分析 API 中使用此方法，可下载应用中错误的 CAB 文件。"
...
在 Windows 应用商店分析 API 中使用此方法，可下载与应用中报告给开发人员中心的特定错误相关联的 CAB 文件。 此方法仅可以下载过去 30 天内发生的应用错误的 CAB 文件。 还可以在 Windows 开发人员中心仪表板的[运行状况报告](../publish/health-report.md)的**故障**部分下载 CAB 文件。
