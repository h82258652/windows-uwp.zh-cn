...
description: "在 Windows 应用商店分析 API 中使用此方法，可下载 Windows 7 或 Windows 8.x 驱动程序错误的 CAB 文件。 此方法仅用于 IHV。"
...
在 Windows 应用商店分析 API 中使用此方法，可下载与特定 Windows 7/Windows 8.x 驱动程序错误相关的 CAB 文件。 开始使用此方法之前，你必须使用[获取 Windows 7 或 Windows 8.x 驱动程序错误的详细信息](get-details-for-a-windows-7-or-windows-8.x-driver-error.md)方法来检索想要下载的 CAB 文件的 ID。

你可以使用 Windows 应用商店分析 API 中的[获取 Windows 7 和 Windows 8.x 驱动程序的错误报告数据](get-error-reporting-data-for-windows-7-and-windows-8.x-drivers.md)和[获取 Windows 7 或 Windows 8.x 驱动程序错误的详细信息](get-details-for-a-windows-7-or-windows-8.x-driver-error.md)方法来获取与 Windows 7/Windows 8.x 驱动程序错误相关的其他信息。
