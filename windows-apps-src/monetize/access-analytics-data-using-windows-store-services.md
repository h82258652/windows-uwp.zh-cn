...
| 见解 | <ul><li>[您的应用程序获取见解数据](get-insights-data-for-your-app.md)</li></ul>  |
...
| 见解 | <ul><li>[桌面应用程序获取见解数据](get-insights-data-for-your-desktop-app.md)</li></ul>  |
