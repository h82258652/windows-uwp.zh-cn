---
Description&#58; 作者：mcleanbyron 如果允许客户在试用期内免费使用你的应用，则可以通过排除或限制试用期内的某些功能，吸引客户升级到完整版本的应用。
title&#58; 排除或限制试用版中的功能 ms.assetid：1B62318F-9EF5-432A-8593-F3E095CA7056 关键字：免费试用版 关键字：免费试用期 关键字：免费试用代码示例 关键字：免费试用代码示例
---
