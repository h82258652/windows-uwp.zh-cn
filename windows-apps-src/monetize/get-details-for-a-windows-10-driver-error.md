...
description: 在 Microsoft Store 分析 API 中使用此方法，可获取 Windows 10 驱动程序错误的详细数据。 此方法仅用于 IHV。
...
ms.locfileid: "1663667"
---
# <a name="get-details-for-a-windows-10-driver-error"></a>获取 Windows 10 驱动程序错误的详细信息

在 Microsoft Store 分析 API 中使用此方法，可以 JSON 格式获取特定 Windows 10 驱动程序错误的详细数据。 可以使用此方法之前，必须首先使用[获取 Windows 10 驱动程序的错误报告数据](get-error-reporting-data-for-windows-10-drivers.md)方法来检索希望获取详细信息的错误的 ID。
