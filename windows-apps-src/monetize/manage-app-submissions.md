...
description: Microsoft Store 提交 API 中使用这些方法来管理到合作伙伴中心帐户注册的应用的提交。
title: 管理应用提交
ms.date: 04/30/2018
ms.topic: article
...
> [!IMPORTANT]
> 如果使用的 Microsoft Store 提交 API 来创建提交的应用程序，请务必进行进一步更改提交到只能通过使用 API，而不是合作伙伴中心。 如果您使用合作伙伴中心更改最初通过使用 API 创建的提交，将不能更改，或者通过 API 提交的提交。 在某些情况下，在提交过程中无法继续进行时，提交可能会处于错误状态。 如果发生这种情况，你必须删除提交并创建新的提交。

> [!IMPORTANT]
> 你无法使用此 API 来直接向企业发布[通过适用于企业的 Microsoft Store 和适用于教育的 Microsoft Store 批量购买](../publish/organizational-licensing.md)的提交或发布 [LOB 应用](../publish/distribute-lob-apps-to-enterprises.md)的提交。 对于这两个方案，必须使用合作伙伴中心发布的提交。
...
使用以下方法获取、创建、更新、提交或删除应用提交。 可以使用这些方法之前，应用必须已存在于你的合作伙伴中心帐户，并必须先在合作伙伴中心创建一个提交的应用程序。 有关详细信息，请参阅[先决条件](create-and-manage-submissions-using-windows-store-services.md#prerequisites)。
...
<td align="left"><a href="get-an-app-submission.md">获取现有的应用程序提交</a></td>
</tr>
<tr>
<td align="left">GET</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}/status</td>
<td align="left"><a href="get-status-for-an-app-submission.md">获取现有的应用程序提交的状态</a></td>
</tr>
<tr>
<td align="left">发布</td>
...
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}</td>
<td align="left"><a href="update-an-app-submission.md">更新现有的应用程序提交</a></td>
</tr>
<tr>
<td align="left">发布</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}/commit</td>
<td align="left"><a href="commit-an-app-submission.md">提交新的或更新应用程序提交</a></td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}</td>
<td align="left"><a href="delete-an-app-submission.md">删除应用程序提交</a></td>
</tr>
</tbody>
</table>
...
5. 通过执行以下方法[确认应用提交](commit-an-app-submission.md)。 完成与您的提交和更新现在应该应用到你的帐户，这将发出警报合作伙伴中心。
...
可在应用提交中逐步向 Windows 10 上一定比例的应用客户推出已更新的软件包。 这使你可以监视特定程序包的反馈和分析数据，从而确保在更广泛地推出更新前对此更新无虑。 可更改已发布提交的推出百分比（或终止更新），而无需创建新提交。 有关详细信息，包括有关如何启用和管理在合作伙伴中心的逐步包推出的说明，请参阅[这篇文章](../publish/gradual-package-rollout.md)。
...
<td align="left"><a href="get-package-rollout-info-for-an-app-submission.md">获取应用程序提交的逐渐推出信息</a></td>
</tr>
<tr>
<td align="left">发布</td>
...
<td align="left"><a href="update-the-package-rollout-percentage-for-an-app-submission.md">更新应用程序提交的逐渐推出百分比</a></td>
</tr>
<tr>
<td align="left">发布</td>
...
<td align="left"><a href="halt-the-package-rollout-for-an-app-submission.md">停止应用程序提交逐渐推出</a></td>
</tr>
<tr>
<td align="left">发布</td>
...
<td align="left"><a href="finalize-the-package-rollout-for-an-app-submission.md">完成应用程序提交逐渐推出</a></td>
</tr>
</tbody>
</table>
...
| 值      | 在任务栏的搜索框中键入   | 描述      |
|------------|--------|-------------------|
| id            | string  | 提交的 ID。 此 ID 包含在 [create an app submission](create-an-app-submission.md)、[get all apps](get-all-apps.md) 和 [get an app](get-an-app.md) 请求的响应数据中。 在合作伙伴中心创建的提交，此 ID 是也可用在合作伙伴中心中的提交页的 URL。  |
...
| hardwarePreferences           |  array  |   一组用于定义应用的[硬件首选项](https://docs.microsoft.com/windows/uwp/publish/enter-app-properties)的字符串。 这可以是以下值之一： <ul><li>触控</li><li>键盘</li><li>鼠标</li><li>相机</li><li>NfcHce</li><li>Nfc</li><li>BluetoothLE</li><li>Telephony</li></ul>     |   
...
| gamingOptions           |  array |   一个包含[游戏选项资源](#gaming-options-object)的数组，用于为应用定义游戏相关设置。     |   
...
|  sales               |   array      |  **已弃用**。 包含应用销售信息的[销售资源](#sale-object)数组。   |     
|  priceId               |   string      |  用于指定应用[基价](https://docs.microsoft.com/windows/uwp/publish/define-pricing-and-market-selection)的[价格段](#price-tiers)。   |     
...
>    * 调用 [GET 方法以获取应用提交](get-an-app-submission.md)后，*销售*值将为空。 您可以继续使用合作伙伴中心以获取应用程序的提交的销售数据。
>    * 调用 [PUT 方法更新应用提交](update-an-app-submission.md)时，将忽略*销售*值中的信息。 您可以继续使用合作伙伴中心更改应用程序的提交的销售数据。
...
|  keywords                |  array       |  [关键字](https://docs.microsoft.com/windows/uwp/publish/create-app-descriptions)数组，用于帮助应用出现在搜索结果中。    |
|  licenseTerms                |    string     | 可选的应用[许可条款](https://docs.microsoft.com/windows/uwp/publish/create-app-descriptions)。     |
|  privacyPolicy                |   string      |   此值已作废。 若要设置或更改你的应用的隐私策略 URL，你必须执行此操作[属性](../publish/enter-app-properties.md#privacy-policy-url)合作伙伴中心中的页。 在调用提交 API 时可以忽略此值。 如果设置此值，它将被忽略。       |
|  supportContact                |   string      |  此值已作废。 若要设置或更改的支持联系人 URL 或电子邮件地址为你的应用，你必须执行此操作[属性](../publish/enter-app-properties.md#support-contact-info)合作伙伴中心中的页。 在调用提交 API 时可以忽略此值。 如果设置此值，它将被忽略。        |
|  websiteUrl                |   string      |  此值已作废。 若要设置或更改您的应用程序的网页的 URL，你必须执行此操作[属性](../publish/enter-app-properties.md#website)合作伙伴中心中的页。 在调用提交 API 时可以忽略此值。 如果设置此值，它将被忽略。      |    
|  description               |    string     |   应用一览的[描述](https://docs.microsoft.com/windows/uwp/publish/create-app-descriptions)。   |     
|  features               |    array     |  一个最多 20 个字符串的数组，用于列出应用的[功能](https://docs.microsoft.com/windows/uwp/publish/create-app-descriptions)。     |
...
此资源包含应用的游戏相关设置。 此资源中的值对应于[游戏设置](../publish/enter-app-properties.md#game-settings)的合作伙伴中心中的提交。
...
| 值           | 在任务栏的搜索框中键入    | 描述        |
|-----------------|---------|------|
|  genres               |    array     |  包含一个或多个下列字符串的数组，用于描述游戏类型： <ul><li>Games_ActionAndAdventure</li><li>Games_CardAndBoard</li><li>Games_Casino</li><li>Games_Educational</li><li>Games_FamilyAndKids</li><li>Games_Fighting</li><li>Games_Music</li><li>Games_Platformer</li><li>Games_PuzzleAndTrivia</li><li>Games_RacingAndFlying</li><li>Games_RolePlaying</li><li>Games_Shooter</li><li>Games_Simulation</li><li>Games_Sports</li><li>Games_Strategy</li><li>Games_Word</li></ul>    |
...
> [!NOTE]
> 当调用[更新应用提交](update-an-app-submission.md)法时，请求正文中仅需要此对象的 *fileName*、*fileStatus*、*minimumDirectXVersion* 和 *minimumSystemRam* 值。 通过合作伙伴中心填充其他值。
...
此资源表示应用一览的视频预告片。 此资源中的值对应于[尾部](../publish/app-screenshots-and-images.md#trailers)合作伙伴中心中的提交的选项。
...
| ReplTest1           | 在任务栏的搜索框中键入    | 描述        |
|-----------------|---------|------|
|  id               |    string     |   预告片的 ID。 通过合作伙伴中心提供此值。   |
|  videoFileName               |    string     |    包含提交文件的 ZIP 存档中预告片视频文件的名称。    |     
|  videoFileId               |   string      |  预告片视频文件的 ID。 通过合作伙伴中心提供此值。   |     
...
> [!NOTE]
> 尽管可以通过提交 API 配置组织授权选项进行应用提交，但你无法使用此 API 发布[通过适用于企业的 Microsoft Store 和适用于教育的 Microsoft Store 批量购买](../publish/organizational-licensing.md)的提交。 若要发布到 Microsoft Store for Business 和教育的 Microsoft Store 提交，必须使用合作伙伴中心。
...
* [获取使用 Microsoft Store 提交 API 的应用程序数据](get-app-data.md)
* [在合作伙伴中心提交应用程序](https://docs.microsoft.com/windows/uwp/publish/app-submissions)
