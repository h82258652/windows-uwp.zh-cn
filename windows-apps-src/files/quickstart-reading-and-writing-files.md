...
1.  首先，调用[**CryptographicBuffer.ConvertStringToBinary**](/uwp/api/windows.security.cryptography.cryptographicbuffer.convertstringtobinary)以获取一个缓冲区的字节 （基于一个字符串） 想要写入到你的文件。
