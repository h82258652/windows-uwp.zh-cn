...
有关如何存储通用 Windows 平台应用数据的指南，请参阅 [ApplicationData](https://msdn.microsoft.com/library/windows/apps/windows.storage.applicationdata.aspx) 类。
