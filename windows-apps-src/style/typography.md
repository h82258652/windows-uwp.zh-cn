...
## <a name="kerning-and-tracking"></a>字距调整和字距
...
## <a name="word-and-letter-spacing"></a>单词和字母间距
...
若要在字体渐变之外创建其他层次结构，请将次要文字的不透明度设置为 60%。 在[“主题调色板”](color.md#color-theming)中，可使用 BaseMedium。 主要文字的不透明度应始终为 100% 或 BaseHigh。
