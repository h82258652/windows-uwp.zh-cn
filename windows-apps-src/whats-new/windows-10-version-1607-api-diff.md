...
keywords: "新增功能, 新增功能, 更新, 更新, 新, Windows 10, 1607, API"
ms.author: quradic
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
...
# <a name="windows-10-api-changes"></a>Windows 10 API 更改

Windows 10 版本 1607 中添加或更改了许多运行时 API。 此表列出了在此版本中添加或更改的命名空间。
