---
author: QuinnRadich
title: "Windows 10 版本 16225 API 更改"
description: "开发人员可以使用以下列表标识 Windows10 SDK 预览版 16190 中新增或更改的命名空间"
keywords: "新增功能, 更新, 已进行外部测试, 外部测试版, API, 16225"
ms.author: quradic
ms.date: 7/6/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Windows10 SDK 预览版 16225 中的新 API

[Windows 预览体验成员](https://insider.windows.com/) 已可使用 Windows 10 SDK 预览版 16225 中的新增的和更新的 API 命名空间。

下面是已发布的预发行版本文档的完整列表，这些文档适用于自上次公开发布 Windows 10 [版本 1703](windows-10-version-1703-api-diff.md) 以来添加或修改的命名空间。 **请注意，预发行版本文档可能不完整和随时进行更改，因此这些 API 在后续版本中可能重命名或被删除。**
