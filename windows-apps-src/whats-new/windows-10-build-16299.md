...
功能 | 说明
 :------ | :------
帐户管理 | 现在，我们提供更大的灵活性时[将 Azure AD 租户与你的合作伙伴中心帐户相关联](../publish/associate-azure-ad-with-dev-center.md)添加多个帐户用户。 你可以将多个 Azure AD 租户与一个合作伙伴中心帐户，相关联，或将关联一个 Azure AD 租户与多个合作伙伴中心帐户。
