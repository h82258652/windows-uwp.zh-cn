...
功能 | 说明
 :------ | :------
帐户管理 | 现在，我们在[将 Azure AD 租户与开发人员中心帐户关联](../publish/associate-azure-ad-with-dev-center.md)时提供更大的灵活性，以便添加多个帐户用户。 你可以将多个 Azure AD 租户与一个开发人员中心帐户关联，也可以将一个 Azure AD 租户与多个开发人员中心帐户关联。
