...
更新的存储 API | 在 [Windows.Storage.DownloadsFolder 类](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder)中，你的应用现在可以在“下载”文件夹内针对特定[用户](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder.createfileforuserasync)[创建文件](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder.createfolderforuserasync)或[创建文件夹](https://docs.microsoft.com/uwp/api/windows.system.user)。 在 [Windows.Storage.StorageLibrary 类](https://docs.microsoft.com/uwp/api/windows.storage.storagelibrary)中，你的应用现在可以针对特定[用户](https://docs.microsoft.com/uwp/api/windows.storage.storagelibrary.getlibraryforuserasync)[获取指定的“库”](https://docs.microsoft.com/uwp/api/windows.system.user)。
