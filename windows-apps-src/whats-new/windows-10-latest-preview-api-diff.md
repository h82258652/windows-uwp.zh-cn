---
author: QuinnRadich
title: "Windows 10 版本 16257 API 更改"
description: "开发人员可以使用以下列表标识当前 Windows10 SDK 预览版中新增或更改的命名空间"
keywords: "新增功能, 更新, 已进行外部测试, 外部测试版, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Windows10 SDK 预览版 16257 中的新 API

[Windows 预览体验成员](https://insider.windows.com/) 已可使用 Windows 10 SDK 预览版 16257 中的新增的和更新的 API 命名空间。

下面是已发布的预发行版本文档的完整列表，这些文档适用于自上次公开发布 Windows 10 [版本 1703](windows-10-version-1703-api-diff.md) 以来添加的命名空间。 **请注意，预发行版本文档可能不完整和随时进行更改，因此这些 API 在后续版本中可能重命名或被删除。** 此外还附加了自上一个 SDK 预览版以来更改或重命名的 API 命名空间的列表。
...
#### [<a name="accelerometer"></a>加速计](https://docs.microsoft.com/uwp/api/windows.devices.sensors.accelerometer)
...
#### [<a name="altimeter"></a>高度计](https://docs.microsoft.com/uwp/api/windows.devices.sensors.altimeter)
...
#### [<a name="barometer"></a>气压计](https://docs.microsoft.com/uwp/api/windows.devices.sensors.barometer)
...
#### [<a name="compass"></a>指南针](https://docs.microsoft.com/uwp/api/windows.devices.sensors.compass)
...
#### [<a name="gyrometer"></a>陀螺测试仪](https://docs.microsoft.com/uwp/api/windows.devices.sensors.gyrometer)
...
#### [<a name="inclinometer"></a>测斜仪](https://docs.microsoft.com/uwp/api/windows.devices.sensors.inclinometer)
...
#### [<a name="magnetometer"></a>磁力仪](https://docs.microsoft.com/uwp/api/windows.devices.sensors.magnetometer)
...
#### [<a name="grid"></a>网格](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### [<a name="block"></a>阻止](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)
...
## <a name="apis-changed-or-removed-since-build-16232"></a>自版本 16232 以来更改或删除的 API

以下 API 在版本 16232 或之前的版本中可用，但在此版本中不再存在。 它们已被重命名或完全删除，并不会再为它们提供文档。
...
## <a name="apis-changed-or-removed-since-build-16225"></a>自版本 16225 以来更改或删除的 API

以下 API 在版本 16225 或之前的版本中可用，但在此版本中不再存在。 它们已被重命名或完全删除，并不会再为它们提供文档。
