...
以下功能已添加至 Windows Insider Preview 版本，可通过[Windows 预览体验](https://insider.windows.com/)计划。

* [Windows UI 库](https://aka.ms/winui-docs)是一组提供适用于 UWP 应用的控件和其他用户 interfact 元素的 NuGet 程序包。 这些程序包也是与早期版本的 Windows 10 兼容，因此即使你的用户无需的最新的操作系统版本的工作原理你的应用。
...
包支持框架可帮助你修复时应用到 win32 应用程序不能访问的源代码，以便它可以 MSIX 容器中运行的开放源代码工具包。
...
已重新[项目 rome 文档](https://docs.microsoft.com/windows/project-rome/)站点组织到功能第一种方法。 这应更便于开发人员可以找到他们要查找的并跨多个平台实现他们所选的功能。
