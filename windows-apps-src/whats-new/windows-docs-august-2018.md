...
* NavigationView 现在支持[顶部导航](../design/controls-and-patterns/navigationview.md)，用于你的应用具有较少的导航选项，并为你的应用的内容需要更多空间的用例。
...
[项目 rome 文档](https://docs.microsoft.com/windows/project-rome/)站点具有已重新整理到功能第一种方法。 这应使开发人员可以找到他们要查找的并实现自己的功能跨多个平台更容易。
