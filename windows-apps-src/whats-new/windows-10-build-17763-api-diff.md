...
ms.locfileid: "63780346"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Windows 10 版本 17763 中的新增 API

开发人员已可使用 Windows 10 版本 17763 中新增的和更新的 API 命名空间（也称为 2018 年 10 月更新或版本 1809）。 下面是为此版本中添加或修改的命名空间所发布的文档的完整列表。

有关上一公共版本中添加的 API 的信息，请参阅 [Windows 10 4 月更新中的新 API](windows-10-build-17134-api-diff.md)。
