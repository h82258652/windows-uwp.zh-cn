...
菜单栏 <br> menubar.items <br> menubar.itemsproperty <br> menubar.menubar
...
拆分按钮 <br> splitbutton.click <br> splitbutton.command <br> splitbutton.commandparameter <br> splitbutton.commandparameterproperty <br> splitbutton.commandproperty <br> splitbutton.flyout <br> splitbutton.flyoutproperty <br> splitbutton.splitbutton
...
#### [<a name="tooltip"></a>工具提示](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### [<a name="brush"></a>画笔](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
