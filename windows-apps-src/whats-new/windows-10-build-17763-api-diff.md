...
#### [<a name="package"></a>包](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### [<a name="border"></a>边框](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### [<a name="control"></a>控件](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### [<a name="frame"></a>帧](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### [<a name="menubar"></a>菜单栏](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

菜单栏 <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> 菜单栏。 #ctor
...
#### [<a name="panel"></a>面板](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### [<a name="splitbutton"></a>拆分按钮](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.splitbutton)
...
#### [<a name="timepicker"></a>TimePicker（时间选择器）](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.timepicker)
