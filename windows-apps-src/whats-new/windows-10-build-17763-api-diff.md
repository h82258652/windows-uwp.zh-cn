---
title: Windows 10 生成 17763 API 更改
description: 开发人员可以使用以下列表识别 Windows 10 生成 17763 中的新增或更改命名空间
keywords: 最新内容、 的新增功能新，更新，Windows 10，最新，api，17763，年 10 月
ms.date: 10/02/2018
ms.topic: article
...
ms.locfileid: "57596322"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Windows 10 中新的 Api 生成 17763

新的和更新 API 命名空间具有已可供开发人员的 Windows 10 生成 17763 (也称为 2018 年 10 月更新或版本 1809年)。 下面是为此版本中添加或修改的命名空间所发布的文档的完整列表。

在以前的公共版本添加有关 Api 的信息，请参阅[Windows 10 年 4 月更新中的新 Api](windows-10-build-17134-api-diff.md)。
...
#### <a name="clipboardhttpsdocsmicrosoftcomuwpapiwindowsapplicationmodeldatatransferclipboard"></a>[剪贴板](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="packagehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelpackage"></a>[包](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### <a name="bitmapdecoderhttpsdocsmicrosoftcomuwpapiwindowsgraphicsimagingbitmapdecoder"></a>[在 BitmapDecoder](https://docs.microsoft.com/uwp/api/windows.graphics.imaging.bitmapdecoder)
...
#### <a name="launcherhttpsdocsmicrosoftcomuwpapiwindowssystemlauncher"></a>[启动器](https://docs.microsoft.com/uwp/api/windows.system.launcher)
...
#### <a name="borderhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsborder"></a>[边框](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### <a name="framehttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsframe"></a>[帧](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### <a name="menubarhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsmenubar"></a>[菜单栏](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

MenuBar <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> 菜单栏。 #ctor
...
#### <a name="panelhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolspanel"></a>[面板](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### <a name="splitbuttonhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolssplitbutton"></a>[拆分按钮](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.splitbutton)

拆分按钮 <br> SplitButton.Click <br> SplitButton.Command <br> SplitButton.CommandParameter <br> SplitButton.CommandParameterProperty <br> SplitButton.CommandProperty <br> SplitButton.Flyout <br> SplitButton.FlyoutProperty <br> 拆分按钮。 #ctor
...
#### <a name="tooltiphttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstooltip"></a>[工具提示](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)

ToolTip.PlacementRect <br> ToolTip.PlacementRectProperty

#### <a name="treeviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstreeview"></a>[树视图](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.treeview)
...
#### <a name="webviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolswebview"></a>[Web 视图](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.webview)
...
#### <a name="brushhttpsdocsmicrosoftcomuwpapiwindowsuixamlmediabrush"></a>[画笔](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
...
#### <a name="datatemplatehttpsdocsmicrosoftcomuwpapiwindowsuixamldatatemplate"></a>[数据模板](https://docs.microsoft.com/uwp/api/windows.ui.xaml.datatemplate)
