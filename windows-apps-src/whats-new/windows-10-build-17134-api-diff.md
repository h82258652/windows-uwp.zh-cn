...
ms.locfileid: "57592442"
---
# <a name="new-apis-in-windows-10-build-17134"></a>Windows 10 版本 17134 中的新增 API

开发人员已可使用 Windows 10 版本 17134 中新增的和更新的 API 命名空间（也称为 4 月更新或版本 1803）。 下面是为此版本中添加或修改的命名空间所发布的文档的完整列表。
...
#### <a name="languagehttpsdocsmicrosoftcomuwpapiwindowsglobalizationlanguage"></a>[语言](https://docs.microsoft.com/uwp/api/windows.globalization.language)
...
#### <a name="videoframehttpsdocsmicrosoftcomuwpapiwindowsmediavideoframe"></a>[是 videoframe](https://docs.microsoft.com/uwp/api/windows.media.videoframe)
...
#### <a name="esimhttpsdocsmicrosoftcomuwpapiwindowsnetworkingnetworkoperatorsesim"></a>[esim 卡](https://docs.microsoft.com/uwp/api/windows.networking.networkoperators.esim)
...
#### <a name="coreindependentinputsourcehttpsdocsmicrosoftcomuwpapiwindowsuicorecoreindependentinputsource"></a>[coreindependentinputsource 都](https://docs.microsoft.com/uwp/api/windows.ui.core.coreindependentinputsource)
