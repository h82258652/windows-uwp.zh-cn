...
| 版本 | 说明 |
| --- | --- |
| 版本 17763 （版本 1809年） | 这是最新版本的 Windows 10，在 2018 年 10 月发布。 **请注意，_必须_使用 Visual Studio 2017 以面向此版本的 Windows。** 此版本中的一些突出功能如下： </br> \* **Windows 机器学习：** Windows 机器学习已现在正式启动，为尖端机器学习模型提供更快地分析和支持等功能。 若要了解有关此平台的详细信息，请参阅 [Windows 机器学习](https://docs.microsoft.com/windows/ai/)。 </br> \* **Fluent Design:** 新功能，例如菜单栏、 命令栏浮出控件，以及 XAML 属性动画已添加到 Windows 10。 请在 [Fluent Design 概述](../design/fluent-design-system/index.md)中查看最新内容。 </br> 有关这些和添加此版本的 Windows 中的许多其他功能的信息，请访问[开发人员中心](https://developer.microsoft.com/windows/windows-10-for-developers)或的详细信息页面上[什么是适用于开发人员的 Windows 10 中的新增功能](../whats-new/windows-10-build-17763.md)
