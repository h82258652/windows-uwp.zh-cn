...
最后，通过新建WebAccountProviderCommand **[ 将提供商添加到 ](https://docs.microsoft.com/uwp/api/windows.ui.applicationsettings.webaccountprovidercommand)AccountsSettingsPane**，如下所示： 
