...
-   *Microsoft 应用商店应用程序*是默认设置。 如果你未正在开发应用或者未使用公司发布的特殊内部应用，则启用此设置。
...
> [!NOTE]
> 如果开发人员模式不正确安装，我们建议您文件反馈请求。 在**反馈集线器**应用程序中，选择**添加新的反馈**，，然后选择**开发人员平台**类别和**开发人员模式**子类别。 提交反馈将帮助 Microsoft 解决您遇到的问题。
