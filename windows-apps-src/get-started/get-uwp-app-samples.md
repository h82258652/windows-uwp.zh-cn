...
> **注意**：UWP 示例需要使用 Visual Studio 2015 和 Windows SDK 才能打开、生成并运行。 如果你尚未安装 Visual Studio，你可以在[此处](http://go.microsoft.com/fwlink/p/?LinkID=280676 "Windows 开发工具下载")获取支持生成 UWP 应用的 Visual Studio 2015 Community Edition 的免费副本。  
>
