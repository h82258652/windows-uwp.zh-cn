        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>准备工作</h3>
                    <p>Visual Studio Community 和 Windows 10 SDK 可为你提供构建出色应用所需的一切 - 而且免费！</p>
                    <ul>
                        <li><a href="//developer.microsoft.com/windows/downloads">下载工具和 SDK</a></li>
                        <li><a href="//docs.microsoft.com/windows/uwp/get-started/get-set-up">需要帮助？</a></li>
                    </ul>
                  </div>
                </div>
            </div>
