...
ms.locfileid: "6666967"
---
# <a name="uwp-on-xbox-one-samples"></a>Xbox One 上的 UWP 示例

有多个已在该平台上运行时优化适用于 Xbox One 的跨平台 UWP 示例。 你可以浏览 GitHub 上的代码，阅读的自述文件和 wiki，克隆到计算机的项目。
