...
### <a name="do-turn-off-mouse-mode"></a>*执行操作：* 关闭鼠标模式

Xbox 用户喜欢它们的控制器。 若要优化控制器输入[禁用鼠标模式](how-to-disable-mouse-mode.md)，并启用方向导航 (也称为[导航和交互重点放在 XY](../design/input/gamepad-and-remote-interactions.md#xy-focus-navigation-and-interaction))。 注意焦点陷阱和无法访问 UI。

### <a name="do-draw-a-focus-rectangle-that-is-appropriate-for-a-10-foot-experience"></a>*执行操作：* 绘制一个聚焦框适用于 10 英尺体验
...
### <a name="consider-draw-to-the-edge-of-the-screen"></a>*请考虑：* 绘制到屏幕边缘
...
### <a name="consider-use-tv-safe-colors"></a>*请考虑：* 使用电视安全颜色

电视不会处理严重的颜色浓度，但计算机监视器会处理。 避免在应用中使用高浓度颜色，以免用户看到奇怪的带状效果或褪色的图像。 另外，请注意，电视间的差异是指在*你的*电视上显示良好的颜色可能不适用于用户。 读取[颜色](../design/devices/designing-for-tv.md#colors)若要了解如何使应用程序向所有人赏心悦目 ！

### <a name="remember-you-can-disable-scaling"></a>*请记住：* 您可以禁用缩放
...
**Xbox 上的应用程序开发人员**事件是在 Xbox 上生成应用的新手开发人员的良好起点。
