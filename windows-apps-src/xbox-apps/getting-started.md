...
1.  在 Xbox One 上激活开发人员模式。 下载应用，、 获取激活代码，并将其输入到你的合作伙伴中心帐户中的[管理 Xbox One 主机](https://partner.microsoft.com/xboxactivate)页面。 有关详细信息，请参阅 [Xbox One 开发人员模式激活](devkit-activation.md)。 
