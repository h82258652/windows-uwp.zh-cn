...
ms.locfileid: "6029369"
---
# <a name="midi"></a>MIDI



本文向你演示了如何枚举 MIDI（乐器数字接口）设备以及从通用 Windows 应用发送和接收 MIDI 消息。 Windows 10 支持 MIDI over USB （类符合和最专有驱动程序），通过蓝牙 LE MIDI (Windows 10 周年纪念版及更高版本)，并可以自由地可用的第三方产品、 MIDI 以太网和路由 MIDI 通过。
