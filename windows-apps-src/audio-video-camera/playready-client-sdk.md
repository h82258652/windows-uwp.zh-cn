...
<table>
    ...
    <tr>
        <th>400</th>
        <td rowspan="2">Windows 10 永远不会将压缩的数字视频内容传递到输出，无论后续 OPL 值如何。 有关压缩的数字视频内容的详细信息，请参阅 [PlayReady 产品的合规性规则](https://www.microsoft.com/playready/licensing/compliance/)。</td>
        <td colspan="2" rowspan="2">不适用\*</td>
    </tr>
    <tr>
        <th>500</th>
