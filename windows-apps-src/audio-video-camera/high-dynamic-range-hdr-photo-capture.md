...
**注意** 本文基于[使用 MediaCapture 捕获照片和视频](capture-photos-and-video-with-mediacapture.md)中讨论的概念和代码，介绍了实现基本照片和视频捕获的步骤。 建议你先熟悉本文中的基本媒体捕获模式，然后再了解更高级的捕获方案。 本文中的代码假设你的应用已有一个正确完成初始化的 MediaCapture 的实例。
