...
-   [**CapturedFrame** ](https://msdn.microsoft.com/library/windows/apps/dn278725)使你能获取通过作为相机捕获帧**SoftwareBitmap**。

-   [**是 VideoFrame** ](https://msdn.microsoft.com/library/windows/apps/dn930917)使你能获取**SoftwareBitmap**的表示形式**是 VideoFrame**。

-   [**FaceDetector** ](https://msdn.microsoft.com/library/windows/apps/dn974129)允许你检测中的人脸**SoftwareBitmap**。
