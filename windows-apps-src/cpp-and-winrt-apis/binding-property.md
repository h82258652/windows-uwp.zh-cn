...
如果忽略的包括`BookstoreViewModel.idl`(的列表，请参阅`MainPage.idl`上方)，然后你将看到**需要 \< 附近"MainViewModel"** 错误。 另一条提示是确保将所有类型都保留在相同的命名空间： 代码一览中显示的命名空间。
