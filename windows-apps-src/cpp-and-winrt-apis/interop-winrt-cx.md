...
ms.locfileid: "4950585"
---
# <a name="interop-between-cwinrt-and-ccx"></a>实现 C++/WinRT 与 C++/CX 之间的互操作
本主题介绍了可用于之间转换的两个帮助程序函数[C + + CX](/cpp/cppcx/visual-c-language-reference-c-cx?branch=live)和[C + + WinRT](/windows/uwp/cpp-and-winrt-apis/intro-to-using-cpp-with-winrt)对象。 你可以使用它们将使用两个语言投影，代码之间的互操作，也可以使用这些函数将逐步迁移代码从 C + + CX 到 C + + WinRT (请参阅[移动到 C + + WinRT 从 C + + CX](move-to-winrt-from-cx.md))。
