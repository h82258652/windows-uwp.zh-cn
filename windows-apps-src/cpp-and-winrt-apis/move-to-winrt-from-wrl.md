...
当你想要将基础原始指针传递给期望**IUnknown**的指针的函数时，使用[**winrt::get_unknown**](/uwp/cpp-ref-for-winrt/windows-foundation-iunknown#getunknown-function)自由函数下, 一个示例中所示。
