...
如需通过项目属性设置的 `cppwinrt.exe` 工具自定义选项的列表，请参阅 [https://github.com/microsoft/xlang/tree/master/src/package/cppwinrt/nuget/readme.md#customizing ]。
