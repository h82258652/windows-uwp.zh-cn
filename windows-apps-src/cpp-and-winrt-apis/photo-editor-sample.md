...
- 使用协同程序，包括使用 co_await、co_return、[IAsyncAction](/uwp/api/windows.foundation.iasyncaction) 和 [IAsyncOperation&lt;TResult&gt;](/uwp/api/windows.foundation.iasyncoperation-1)   。
