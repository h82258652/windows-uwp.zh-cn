...
| [集合通过 C + + WinRT](collections.md) | C + + WinRT 提供的函数和你节省大量时间和精力当你想要实现和/或传递集合的基类。 |
...
| [创作 COM 组件通过 C + + WinRT](author-coclasses.md) | C + + WinRT 有助于创作传统的 COM 组件，就像它有助于你创作 Windows 运行时类。 |
...
| 主题 | 说明 |
| - | - |
| [值类别和对它们的引用](cpp-value-categories.md) | 本主题介绍了各种类别的 c + + 中存在的值。 你将肯定听到的左值和 rvalues，但也有其他类型。 |
