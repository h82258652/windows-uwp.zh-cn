...
<tbody>
<tr class="odd">
<td align="left"><p>[不透明和 1 位 alpha 纹理](opaque-and-1-bit-alpha-textures.md)</p></td>
<td align="left"><p>纹理格式 BC1 适用于不透明或具有一种透明色的纹理。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[使用 alpha 通道的纹理](textures-with-alpha-channels.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[块压缩](block-compression.md)</p></td>
<td align="left"><p>块压缩是一种有损纹理压缩技术，用于减小纹理大小并减少内存占用，从而提高性能。 块压缩纹理可以比每种颜色 32 位的纹理小。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[压缩的纹理格式](compressed-texture-formats.md)</p></td>
