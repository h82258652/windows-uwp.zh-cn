...
ms.locfileid: "57659762"
---
# <a name="arena-apis-a-comprehensive-list-of-ui-metadata"></a>竞技场 Api:UI 元数据的完整列表
...
注册开始/结束时间 | 仲裁状态：已完成，无、 已取消，没有提供结果，部分结果 | 注册日期 - 注册团队的日期和时间。 |
报到开始/结束时间 | 比赛描述性“标签”–（“决赛，热度 1”） | 团队战绩 | 正在注册
