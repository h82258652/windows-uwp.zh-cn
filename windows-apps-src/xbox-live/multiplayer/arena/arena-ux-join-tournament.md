...
## <a name="xbox-arena-ui-team-formation"></a>Xbox 竞技场 UI:团队组建
...
## <a name="xbox-arena-ui-registration"></a>Xbox 竞技场 UI:注册

Arena UI 向玩家提供注册团队的方法。 对游戏没有任何要求。

###### <a name="ui-example-register-a-team"></a>UI 示例：注册一个团队
...
> [与匹配参与](arena-ux-match-engagement.md)
