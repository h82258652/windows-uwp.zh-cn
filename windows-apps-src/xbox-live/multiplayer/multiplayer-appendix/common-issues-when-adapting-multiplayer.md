...
ms.openlocfilehash: 2fde82788345377b41c26a4a6dc7c736225918f3
...
2015 多人游戏的游戏必须：在进入游戏代码的多人游戏区域前始终调用 **RealTimeActivityService.EnableMultiplayerSubscriptions 方法**。 此调用同时支持会话更改订阅和断开连接检测订阅。
