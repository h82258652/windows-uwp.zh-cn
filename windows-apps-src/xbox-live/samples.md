...
这些示例这两个 Xbox Live Creators 计划和ID@Xbox展示的 Xbox Live API 的使用情况可在 Xbox Live 示例 GitHub 存储库，请参阅 [https://github.com/Microsoft/xbox-live-samples](https://github.com/Microsoft/xbox-live-samples)
