...
### [Xbox Live 资源](xbox-live-resources.md)
...
### [以托管的合作伙伴或 ID@Xbox 开发人员的身份开始使用 Xbox Live](get-started-with-partner/get-started-with-xbox-live-partner.md)
#### [创建适用于 Xbox Live 的新主题作品](get-started-with-partner/create-a-new-title.md)
