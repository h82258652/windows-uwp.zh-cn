...
你可以：
  ...
  2. 将的关注者列表添加到用户的社交图，从文本文件或 Xbox 开发人员平台 csv
...
Xbox Live 帐户工具可作为从 Xbox Live 工具包的一部分[ https://aka.ms/xboxliveuwptools ](https://aka.ms/xboxliveuwptools)。
...
导航至“信誉”选项卡。选择你想要的默认值，然后按下“提交更改”按钮即可提交请求。 如果请求成功，那么你应该可以看到信誉统计值更改。

## <a name="what-do-the-values-in-the-reputation-tab-mean"></a>“信誉”选项卡中的值代表什么？
总体信誉是从三个子可信计算的：Fairplay （多玩家行为准则）、 用户生成的内容 （视频剪辑和类似） 和 （消息和语音） 的通信。 每个类别的原始值在 0 到 75 之间，其中越高的值表示用户的信誉越好。 OverallStatIsBad 将告诉你用户是否具有“避开我”信誉。
