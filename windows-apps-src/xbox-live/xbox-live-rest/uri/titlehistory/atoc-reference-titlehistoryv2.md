...
ms.locfileid: "3935449"
---
# <a name="achievement-title-history-uris"></a>成就标题历史记录 Uri
 
本部分提供有关统一资源标识符 (URI) 地址和关联的超文本传输协议 (HTTP) 方法的详细信息从 Xbox Live 服务相关的成就*游戏历史记录*。 在所有平台上运行的游戏均可读取此历史记录的信息。
