...
此 HTTP/REST 方法在服务配置 ID (SCID) 级别的命名漏斗中删除指定的票证 ID。 此方法可由**Microsoft.Xbox.Services.Matchmaking.MatchmakingService.DeleteMatchTicketAsync**包装。  
<a id="ID4E2"></a>
