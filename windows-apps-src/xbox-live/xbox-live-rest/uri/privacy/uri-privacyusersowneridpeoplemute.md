...
ms.locfileid: "3881382"
---
# <a name="usersowneridpeoplemute"></a>/users/ {ownerId} / 人员/静音
访问用户的静音列表。
...
[GET （/users/ {ownerId} / 人员/静音）](uri-privacyusersowneridpeoplemuteget.md)
