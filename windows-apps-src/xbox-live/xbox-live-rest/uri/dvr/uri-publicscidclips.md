...
ms.locfileid: "3880419"
---
# <a name="publicscidsscidclips"></a>/ 公用/scid / {scid} / 剪辑
访问公共剪辑。 实际上可以在两个窗体中指定的此 URI`/public/scids/{scid}/clips`和`/public/titles/{titleId}/clips`。 有关详细信息，请参阅下方。 此 uri 域是`gameclipsmetadata.xboxlive.com`。
