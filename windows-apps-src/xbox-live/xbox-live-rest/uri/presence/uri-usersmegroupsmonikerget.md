...
ms.locfileid: "3961196"
---
# <a name="get-usersmegroupsmoniker-"></a>获取 (/ 用户/me/组 / {名字对象})
...
检索相关索赔项目，用户的名字对象由指定的组中的用户，并返回这些用户的 presencerecord，他。 受隐私或内容隔离的数据将只是不会返回。
