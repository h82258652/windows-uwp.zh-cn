---
title: 获取 （/用户/xuid ({xuid}) /groups/ {名字对象} / 广播/计数）
...
author: KevinAsgari
description: " 获取 （/用户/xuid ({xuid}) /groups/ {名字对象} / 广播/计数）"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3956388"
---
# <a name="get-usersxuidxuidgroupsmonikerbroadcastingcount-"></a>获取 （/用户/xuid ({xuid}) /groups/ {名字对象} / 广播/计数）
