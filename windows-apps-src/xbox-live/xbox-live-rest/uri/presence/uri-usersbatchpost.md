...
此批处理请求的响应可由深度和路径的筛选器。 使用者可以使用此找出并显示有关一组用户的状态。 此 API 上的筛选器为 Or 中一个属性，而 And 跨工作属性。
...
| 成员| 说明|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 用户| 用户想要了解，最多个一次 1100 Xuid 状态的列表 XUIDs。|
...
| onlineOnly| 如果此属性为 true，批处理操作筛选掉记录脱机用户 （包括遮盖的）。 如果未提供，联机和脱机用户将会返回。|
