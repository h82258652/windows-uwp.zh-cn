...
ms.locfileid: "5824589"
---
# <a name="get-usersxuidxuidgroupsmoniker-"></a>GET (/users/xuid({xuid})/groups/{moniker} )
Presencerecord，他获取一组。 这些 Uri 的域是`userpresence.xboxlive.com`。
...
检索与 URI 中用户的名字对象由指定的组中的用户，并返回这些用户的 presencerecord，他。 受隐私或内容隔离的数据将只是不会返回。
...
| X XblCorrelationId| 字符串| 若要将服务器的返回并什么由客户端接收的服务生成的值。 示例值:"4106d0bc-1cb3-47bd-83fd-57d041c6febe"。| 
