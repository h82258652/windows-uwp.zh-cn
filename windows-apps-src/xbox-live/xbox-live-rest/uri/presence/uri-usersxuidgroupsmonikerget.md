...
ms.locfileid: "3936197"
---
# <a name="get-usersxuidxuidgroupsmoniker-"></a>获取 (/ 用户/xuid ({xuid}) /groups/ {名字对象})
...
检索与在 URI 中用户的名字对象由指定的组中的用户，并返回这些用户的 presencerecord，他。 受隐私或内容隔离的数据将只需不会返回。
