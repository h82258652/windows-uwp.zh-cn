...
ms.locfileid: "3880589"
---
# <a name="post-usersowneridpeoplexuids"></a>POST (/users/ {ownerId} / 人员/xuid)
...
如果"获取"方法调用成功，该服务集合和数组，其中包含调用方的用户集合返回的用户总数中调用方的人。 "添加"和"删除"方法将返回无响应。 请参阅[PeopleList (JSON)](../../json/json-peoplelist.md)。
...
[/users/ {ownerId} / 人员/xuid](uri-usersowneridpeoplexuids.md)
