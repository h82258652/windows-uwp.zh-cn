...
ms.locfileid: "3932831"
---
# <a name="get-usersowneridpeopletargetid"></a>获取 (/users/ {ownerId} /people/ {targetid})
...
如果调用成功，该服务返回的目标人员。 请参阅[人 (JSON)](../../json/json-person.md)。
