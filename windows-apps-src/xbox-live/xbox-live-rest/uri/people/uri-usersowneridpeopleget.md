...
ms.locfileid: "3881091"
---
# <a name="get-usersowneridpeople"></a>获取 (/users/ {ownerId} / 用户)
获取调用方的用户集合。
...
| 参数| 类型| 说明|
| --- | --- | --- | --- | --- | --- |
| 视图| 字符串| 返回与视图关联的用户。 默认值为"所有"。 可能的值为： <ul><li><b>所有</b>-返回用户联系人列表中的所有人。 这是默认值。</li><li><b>最喜爱</b>的用户的人脉列表具有最喜爱的人物属性返回的所有人。</li><li><b>LegacyXboxLiveFriends</b> -返回用户的人脉列表中的用户也是旧 Xbox LIVE 好友的所有人。</li></br>**注意：** 如果调用用户是不同于所属的用户，则支持**所有**的值。|
...
[/users/ {ownerId} / 用户](uri-usersowneridpeople.md)
