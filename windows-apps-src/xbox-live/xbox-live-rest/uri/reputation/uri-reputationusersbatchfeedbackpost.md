...
| sessionRef| 对象| 描述 MPSD 会话的对象此反馈与之，则为 NULL。| 
...
| X RequestedServiceVersion| 101| 生成此请求应定向到 Xbox LIVE 的服务的名称/数。 请求将仅可路由到服务验证该标头，身份验证令牌中的声明的有效性后等。| 
