---
title: 获取 (/media/ {marketplaceId} / 元数据/mediaGroups)
...
author: KevinAsgari
description: " 获取 (/media/ {marketplaceId} / 元数据/mediaGroups)"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3932365"
---
# <a name="get-mediamarketplaceidmetadatamediagroups"></a>获取 (/media/ {marketplaceId} / 元数据/mediaGroups)
