---
title: /media/ {marketplaceId} / 元数据/mediaItemTypes
...
author: KevinAsgari
description: " /media/ {marketplaceId} / 元数据/mediaItemTypes"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3956462"
---
# <a name="mediamarketplaceidmetadatamediaitemtypes"></a>/media/ {marketplaceId} / 元数据/mediaItemTypes
...
[获取 (/media/ {marketplaceId} / 元数据/mediaItemTypes)](uri-medialocalemetadatamediaitemtypesget.md)
