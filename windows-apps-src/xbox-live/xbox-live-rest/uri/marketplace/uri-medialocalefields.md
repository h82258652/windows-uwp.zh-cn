...
ms.locfileid: "3880849"
---
# <a name="mediamarketplaceidfields"></a>/media/ {marketplaceId} / 字段
访问字段令牌。 这些 Uri 的域是`eds.xboxlive.com`。
...
[获取 (/media/ {marketplaceId} / 字段)](uri-medialocalefieldsget.md)
