...
为某个给定的查询精选值 (例如，"subgenres 给定流派中") 中获取子值的列表。 这些 Uri 的域是`eds.xboxlive.com`。
...
名为**queryRefinerValue**，这是为了使用的字符禁止在 URI 杆传递允许查询精选值的查询字符串参数传入查询精选值。
