...
成功用户将消息发送到玩家，无论该玩家好友，会导致为 200 的结果代码。 但是，如果你向已阻止你的任何人发送一条消息，接收者不会收到的消息，并将不会收到任何指示你的消息未成功。

在多少消息可发送每天和多少好友和非好友，如下所示还存在限制。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 200| 成功。|
| 400| 收件人的列表为空，或超出最大长度。指定玩家代号和 XUID; 或或 messageText 太长。|
| 403| XUID 无法转换。|
| 404| 玩家代号无效或找不到用户。|
| 409| 用户已到达由系统的每日限制。|
| 500| 常规的服务器端错误。|
