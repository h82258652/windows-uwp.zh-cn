...
这些 REST Uri 的调用方必须为 X-Xbl-协定的版本，指定的服务版本娱乐发现服务 (EDS) 的 HTTP 标头传递值 104/105 或更高版本。
...
[/serviceconfigs/ {scid} {sessionTemplateName} /sessiontemplates/ /sessions/ {会话名} / 成员/me](uri-serviceconfigsscidsessiontemplatessessiontemplatenamesessionssessionnamemembersme.md)

&nbsp;&nbsp;支持删除操作，以删除会话成员。

[/serviceconfigs/ {scid} /sessiontemplates/ {sessionTemplateName} {会话名} /sessions/ /servers/ {server name}](uri-serviceconfigsscidsessiontemplatessessiontemplatenamesessionnamemembersservername.md)
