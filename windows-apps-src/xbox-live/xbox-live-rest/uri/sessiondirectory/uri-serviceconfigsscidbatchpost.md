...
此 HTTP/REST 方法在多个 Xbox 用户 Id，在服务配置 ID (SCID) 级别上创建批查询。 此方法可以通过**Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetSessionsForUsersFilterAsync**换行。
