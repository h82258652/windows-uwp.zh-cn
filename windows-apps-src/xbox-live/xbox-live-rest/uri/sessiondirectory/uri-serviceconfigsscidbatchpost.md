...
ms.locfileid: "3880661"
---
# <a name="post-serviceconfigsscidbatch"></a>POST (/serviceconfigs/ {scid} / 批次)
...
此 HTTP/REST 方法在多个 Xbox 用户 Id，在服务配置 ID (SCID) 级别上创建批查询。 此方法可以由**Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetSessionsForUsersFilterAsync**包装。
...
[/serviceconfigs/ {scid} / 批处理](uri-serviceconfigsscidbatch.md)
