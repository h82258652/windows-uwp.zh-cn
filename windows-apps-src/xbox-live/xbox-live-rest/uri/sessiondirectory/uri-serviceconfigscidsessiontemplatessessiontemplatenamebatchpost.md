...
此 HTTP/REST 方法在多个 Xbox 用户 Id 在会话模板级别上创建批查询。 此方法可由**Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetSessionsForUsersFilterAsync**包装。
