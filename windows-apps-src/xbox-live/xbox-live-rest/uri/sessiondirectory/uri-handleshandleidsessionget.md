...
此 HTTP/REST 方法检索会话对象在服务器上，使用所提供的服务端指针对会话 （句柄）。 返回会话对象，使用所有属性。 此方法可以通过**Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetCurrentSessionByHandleAsync**换行。
