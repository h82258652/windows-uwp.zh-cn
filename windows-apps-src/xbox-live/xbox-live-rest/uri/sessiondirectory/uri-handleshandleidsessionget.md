...
此 HTTP/REST 方法从使用提供的服务端将指向会话 （句柄） 的服务器中检索会话对象。 返回是会话对象，使用所有属性。 此方法可以由**Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetCurrentSessionByHandleAsync**包装。
