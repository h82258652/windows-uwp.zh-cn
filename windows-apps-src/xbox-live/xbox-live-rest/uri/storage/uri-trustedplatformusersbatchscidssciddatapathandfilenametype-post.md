---
title: POST (/ trustedplatform/用户/批处理/scid / {scid} /data/ {pathAndFileName} {类型})
...
author: KevinAsgari
description: " POST (/ trustedplatform/用户/批处理/scid / {scid} /data/ {pathAndFileName} {类型})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3936217"
---
# <a name="post-trustedplatformusersbatchscidssciddatapathandfilenametype"></a>POST (/ trustedplatform/用户/批处理/scid / {scid} /data/ {pathAndFileName} {类型})
