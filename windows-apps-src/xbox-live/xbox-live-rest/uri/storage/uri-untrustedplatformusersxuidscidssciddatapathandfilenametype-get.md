---
title: 获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
...
author: KevinAsgari
description: " 获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3931298"
---
# <a name="get-untrustedplatformusersxuidxuidscidssciddatapathandfilenametype"></a>获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
