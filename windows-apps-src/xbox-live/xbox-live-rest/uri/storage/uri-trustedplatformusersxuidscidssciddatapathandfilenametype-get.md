---
title: 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
...
author: KevinAsgari
description: " 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3934819"
---
# <a name="get-trustedplatformusersxuidxuidscidssciddatapathandfilenametype"></a>获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
