...
| 参数| 类型| 说明| 
| --- | --- | --- | --- | --- | --- | 
| 选择| 字符串| 仅 json 类型时才可用。 指定响应只应包含特定属性/值的 JSON，通过此参数确定。 使用"点"（.） 来指定子属性，并放在方括号 ([和]) 来指定数组的索引。 例如，"array1 [4].prop2"指定的"array1"数组的索引 4"prop2"属性。| 
