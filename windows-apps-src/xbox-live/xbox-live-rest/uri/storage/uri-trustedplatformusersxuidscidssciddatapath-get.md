---
title: 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})
...
author: KevinAsgari
description: " 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3958826"
---
# <a name="get-trustedplatformusersxuidxuidscidssciddatapath"></a>获取 (/trustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})
