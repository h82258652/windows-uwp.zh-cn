---
title: 获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})
...
author: KevinAsgari
description: " 获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3933613"
---
# <a name="get-untrustedplatformusersxuidxuidscidssciddatapath"></a>获取 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{path})
