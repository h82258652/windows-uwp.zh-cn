---
title: 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid})
...
author: KevinAsgari
description: " 获取 (/trustedplatform/users/xuid({xuid})/scids/{scid})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
---
# <a name="get-trustedplatformusersxuidxuidscidsscid"></a>获取 (/trustedplatform/users/xuid({xuid})/scids/{scid})
