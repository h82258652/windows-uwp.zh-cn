...
ms.locfileid: "3881216"
---
# <a name="get-sessionssessionidscidsscid"></a>获取 (/sessions/ {sessionId} /scids/ {scid})
...
如果在调用成功，该服务将返回[quotaInfo (JSON)](../../json/json-quota.md)对象。 
