---
title: 删除 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
...
author: KevinAsgari
description: " 删除 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3929520"
---
# <a name="delete-untrustedplatformusersxuidxuidscidssciddatapathandfilenametype"></a>删除 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})
