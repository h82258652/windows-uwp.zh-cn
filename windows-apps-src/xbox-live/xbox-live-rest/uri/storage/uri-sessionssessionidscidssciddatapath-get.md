---
title: 获取 (/sessions/ {sessionId} {scid} /scids/ /data/ {路径})
...
author: KevinAsgari
description: " 获取 (/sessions/ {sessionId} {scid} /scids/ /data/ {路径})"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3963136"
---
# <a name="get-sessionssessionidscidssciddatapath"></a>获取 (/sessions/ {sessionId} {scid} /scids/ /data/ {路径})
