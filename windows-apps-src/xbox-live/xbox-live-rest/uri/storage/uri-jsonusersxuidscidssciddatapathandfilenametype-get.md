---
title: 获取 (/json/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},json)
...
author: KevinAsgari
description: " 获取 (/json/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},json)"
ms.author: kevinasg
ms.date: 20-12-2017
ms.topic: article
ms.prod: windows
...
ms.locfileid: "3931485"
---
# <a name="get-jsonusersxuidxuidscidssciddatapathandfilenamejson"></a>获取 (/json/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},json)
