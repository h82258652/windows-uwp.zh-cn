...
| <b>dateRecorded</b>| DateTime| 开始录制，采用 UTC 的时间。 封送作为字符串采用 ISO 8601 格式 （有关详细信息，请参阅<a href="https://www.w3.org/TR/NOTE-datetime">日期和时间格式</a>）。| 
...
| <b>源</b>| [GameClipSource 枚举](../enums/gvr-enum-gameclipsource.md)| 指定如何该剪辑的源，作为枚举的字符串值封送。| 
| <b>可见性</b>| [GameClipVisibility 枚举](../enums/gvr-enum-gameclipvisibility.md)| 一旦发布在系统中指定的可见性游戏剪辑。| 
...
| <b>thumbnailOffsetMillseconds</b>| 32 位有符号的整数| 指定偏移生成缩略图的偏移量 （以毫秒为单位）。 仅指定当<b>thumbnailSource</b>设置为偏移量。| 
