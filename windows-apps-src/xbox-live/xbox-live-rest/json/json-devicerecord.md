...
| 成员| 类型| 说明| 
| --- | --- | --- | 
| type| 字符串| 设备的设备类型。 可能的用途包括"D"、"Xbox360"、"MoLIVE"(Windows)、"WindowsPhone"、"WindowsPhone7"和"PC"(G4WL)。 如果的类型是未知 （适用于示例 iOS、 Android 或 web 浏览器中嵌入一个标题），则返回"Web"。| 
| 标题| [TitleRecord](json-titlerecord.md)的数组| 在此设备上的标题的列表。| 
