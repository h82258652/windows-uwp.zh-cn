...
| Content-Type| 应用程序/xml、 应用程序/json、 multipart/表单数据或应用程序/x-www-窗体-urlencoded| 指定提交的请求的内容的类型。| 
| Content-Length| 整数值| 指定提交在 POST 请求中的数据的长度。| 
| 接受的语言 | String| 指定如何本地化任何返回的字符串。 有效的语言/区域设置组合列表，请参阅<a href="http://msdn.microsoft.com/en-us/library/bb975829.aspx">高级 Xbox 360 编程</a>。| 
