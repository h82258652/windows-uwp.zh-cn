...
ms.locfileid: "3880732"
---
# <a name="eds-common-headers"></a>EDS 公共标头
...
| <b>x xbl 父 ig</b>| "Chained"调用的上一印象 Guid| 否 （但强烈建议）| 重要的 BI 相关性。 例如，浏览调用的 IG 是以下父 IG 详细调用。|
...
| <b>x xbl 错误</b>| 错误| 否| 从各种数据提供程序的错误的列表。|
