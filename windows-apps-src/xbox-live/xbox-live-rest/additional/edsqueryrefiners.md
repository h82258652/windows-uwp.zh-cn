...
可以使用以下参数来优化更有针对性的项目集娱乐发现服务 (EDS) 查询。 无这些参数必需的任何 API 中，但他们要接受接受查询优化器的任何 API。
...
| <b>labelOwner</b>| 字符串| 与艺术家、 唱片集或跟踪相关联的音乐标签。| 
...
| <b>xboxAvatarStores</b>| 字符串的数组| 存储到的所有 Xbox 必须属于头像项的列表。| 
