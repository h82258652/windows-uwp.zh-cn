...
ms.locfileid: "5162024"
---
# <a name="standard-http-status-codes"></a>标准 HTTP 状态代码
 
超文本传输协议 (HTTP) 标准描述中向客户端请求的响应服务器返回的状态代码的数量。 Xbox Live 服务方法将返回 HTTP 协议符合标准状态代码来描述请求的状态。
...
> [!NOTE] 
> 某些资源和方法提供的含义的特定状态代码，该资源或方法的上下文中的特定信息。 有关更多详细信息，请参阅文档中针对资源或你所使用的方法。 
