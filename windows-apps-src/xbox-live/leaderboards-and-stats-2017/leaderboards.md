...
[特别推荐的统计数据](stats2017.md#configured-stats-and-featured-leaderboards)的排行榜始终显示在游戏的游戏中心和时它被固定到主页，有时显示为游戏的 UI 的一部分。 你配置的特别推荐的统计数据还可用于你的游戏内创建排行榜。
