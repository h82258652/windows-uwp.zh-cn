...
* [XIM（Xbox 集成多人游戏）](../multiplayer/xbox-integrated-multiplayer-overview.md)的预生产版本现已可用于 XDK 开发。  XIM 是一个自包含界面，可通过 Xbox Live 服务功能向你的游戏轻松添加多人游戏实时网络和聊天通信。
...
* [多人游戏管理器](../multiplayer/multiplayer-manager.md)、[XIM](../multiplayer/xbox-integrated-multiplayer-overview.md) 和 Xbox Live 的[多人游戏概念](../multiplayer/multiplayer-concepts.md)提供了新文档。
...
## <a name="tools"></a>工具
* Xbox Live 跟踪分析器（可在 [http://aka.ms/XboxLiveTools](http://aka.ms/XboxLiveTools) 找到）现在具有 CERT 模式。  
