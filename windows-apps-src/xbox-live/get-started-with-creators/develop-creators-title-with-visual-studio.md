...
每个 Xbox Live 主题作品必须具有之前你将能够登录并进行 Xbox Live 服务调用在[合作伙伴中心](https://partner.microsoft.com/dashboard)中创建的产品。 有关详细信息，请参阅[创建新创意者主题作品](create-and-test-a-new-creators-title.md)。
