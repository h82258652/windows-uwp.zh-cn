...
3. **[Visual Studio](https://www.visualstudio.com/)** 使用**通用 Windows 应用开发工具**。 最低要求适用于 UWP 应用的版本是 Visual Studio 2015 Update 3。 我们建议你使用最新版本的 Visual Studio 开发人员和安全更新。 
...
每个 Xbox Live 主题作品必须具有之前你将能够登录并进行 Xbox Live 服务调用在[合作伙伴中心](https://partner.microsoft.com/dashboard)中创建的产品。 有关详细信息，请参阅[在 UDC 上创建作品](create-a-new-title.md)。
