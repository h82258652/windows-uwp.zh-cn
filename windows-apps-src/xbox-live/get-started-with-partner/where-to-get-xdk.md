...
ms.locfileid: "3880421"
---
# <a name="how-to-get-the-xbox-development-kit-xdk"></a>如何获取 Xbox 开发工具包 (XDK)

Xbox 开发工具包 (XDK) 公开不可用。 有两个组，托管的合作伙伴和ID@Xbox开发人员允许访问 XDK 和关联的开发资源，如文档和中间件的工具。 可以从 XDK[软件下载页面](https://developer.microsoft.com/en-us/games/xbox/partner/resources-softwaredownloads)developer.microsoft.com 网站上。

如果你没有访问该站点的访问权限将无法下载或使用 XDK。 如果你不无法访问联系你的帐户管理员。

为了有资格获取 XDK 访问权限，你可以[应用以成为ID@Xbox开发人员](https://www.xbox.com/en-us/Developers/id)。
[单击此处](../developer-program-overview.md)以了解有关ID@Xbox计划和其他开发人员层。
...
XDK 访问还将授予访问权限将指导你完成它的使用的资源。 就像的 XDK 这些资源不是公共和，仅适用于ID@Xbox和托管的合作伙伴开发人员。

- 阅读有关在[XDK 文档](https://developer.microsoft.com/en-us/games/xbox/partner/development-documentation)中使用 Xbox Live 开发工具包。
- 获取更多帮助可以获得社区的帮助，请参阅[开发人员论坛](https://forums.xboxlive.com/index.html)或联系你的帐户管理员。
