...
---
# <a name="where-to-get-the-xbox-development-kit-xdk"></a>获取 Xbox 开发工具包 (XDK) 的位置
...
- Xbox One XDK
- Visual Studio
    - Visual Studio 2012、Visual Studio 2015 或 Visual Studio 2017

## <a name="permissions"></a>权限
若要下载 XDK，为你的应用配置 Xbox Live 服务并访问开发人员支持论坛，请联系你的帐户管理员。
