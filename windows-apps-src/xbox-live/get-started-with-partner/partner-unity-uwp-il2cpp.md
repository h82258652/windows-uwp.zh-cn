...
安装 Unity 5.6 或更高版本，并确保你在安装过程中选择了“Windows 应用商店 Il2CPP 脚本后端”
...
**4) 在“Unity 生成设置”菜单中将平台切换到 Windows 应用商店**

**5) 在 Unity 播放器设置中启用 IL2CPP 脚本后端，并将 API 兼容性设置为 .NET 4.6**

![](../images/unity/unity-il2cpp-1.png)

**6) 导入最新版本的 Xbox Live WinMD Unity 资源包** 这可以在 https://github.com/Microsoft/xbox-live-api/releases 中找到
