...
2.  合作伙伴中心： 在此[门户](https://partner.microsoft.com/dashboard)，你可以保留用于 UWP 开发今天和设置 Xbox Live 配置适用于 UWP 的应用标识。
...
一般来说，发布 XDK + UWP 游戏都遵循相同的进程分别在 XDP 和合作伙伴中心中的在 UWP 中发布 XDK 主题作品。 因此，下面将重点介绍制作跨平台游玩游戏的独特过程和注意事项。
