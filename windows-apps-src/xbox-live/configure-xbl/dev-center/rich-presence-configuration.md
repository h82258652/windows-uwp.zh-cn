---
title: 在合作伙伴中心的富存在配置
description: 了解如何在合作伙伴中心中配置丰富的状态字符串
ms.date: 02/27/2018
ms.topic: article
ms.localizationpriority: medium
keywords: Xbox Live、 Xbox、 游戏、 uwp、 windows 10 中，一个 Xbox、 丰富的状态字符串，合作伙伴中心
ms.openlocfilehash: 5c2add99c6fc6ad1c7f085eb35dc4fdba9e0688d
ms.sourcegitcommit: b034650b684a767274d5d88746faeea373c8e34f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/06/2019
ms.locfileid: "57624122"
---
# <a name="configure-rich-presence-in-partner-center"></a>在合作伙伴中心中配置丰富的状态
...
- 你的标题必须在合作伙伴中心中注册，并为 Xbox Live 已启用。

可以使用丰富的状态字符串之前必须在合作伙伴中心进行配置。

## <a name="rich-presence-configuration-page"></a>Rich Presence 配置页面

丰富的状态字符串配置为用于你的标题中的 Xbox Live 服务的一部分[合作伙伴中心](https://partner.microsoft.com/dashboard)。

通过以下说明导航到 Rich Presence 配置页：

1. 转到[合作伙伴中心](https://partner.microsoft.com/dashboard)developer.microsoft.com 上。
...
![丰富存在页配置的示例](../../images/rich_presence/RichPresence_ConfigPage_Configured.JPG)
