...
ms.openlocfilehash: 341af3fcb5378defeb480f4ee6fcc2e7a7fbc80d
...
以下服务将实施 FGRL 限制，该限制将于** 2016 年 5 月开始实施**。 重申一点，在所有沙盒和游戏中，这些限制都将保持不变。 **目前处于 XDP 或开发人员中心并在 2016 年 5 月前后发货的任何游戏都将被视为旧版游戏，因此将免受限制。** 以下限制尚未最终确定

| **服务名称**          | **突增限制（每个游戏的每位用户 15 秒）** | **持续限制（每个游戏的每位用户 300 秒）** |
|---------------------------|-------------------------------------------------|----------------------------------------------------|
| 游戏剪辑传输       | 50                                              | 300                                                |
| 游戏剪辑元数据       | 50                                              | 300                                                |
| 智能匹配（非 MPSD）    | 10                                              | 100                                                |
...
### <a name="what-about-my-existing-title"></a>我的现有游戏将如何？

在 RETAIL 中实施限制之前，位于 XDP 或开发人员中心的任何游戏都将被视为旧版游戏，并将免受限制。
