...
Xbox Live 是一个卓越的游戏网络，连接着世界各地的数百万玩家。 你可以将 Xbox Live 添加到 Windows 10 或 Xbox One 游戏中，以充分利用 Xbox Live 的功能和服务。

借助 Xbox Live 创意者计划，拥有[合作伙伴中心](https://partner.microsoft.com/dashboard)帐户的任何人都可以构建支持 Xbox Live 的通用 Windows 平台 (UWP) 游戏，这些游戏可以同时在 Windows 10 电脑和 Xbox One 主机上运行。
...
> [!note]
> 这些主题适用于希望游戏支持 Xbox Live 的游戏开发人员。 如果你要查找 Xbox Live 用户信息，请参阅 [Xbox Live](https://www.xbox.com/live/)。
...
| 主题                                                                                                                                             | 描述                                                                                                   |
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| [开发人员计划概述](developer-program-overview.md) | 讨论了支持 Xbox Live 开发的各种开发人员计划。 |
...
在创建了作品并使基本功能发挥作用后，本部分提供了在你切入并开始编码前所需的背景知识。

| 主题                                                                                                                                             | 描述                                                                                                   |
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| [使用 Xbox Live](using-xbox-live/using-xbox-live.md) | 在设置了你的作品并集成了 Xbox Live SDK 后，你就可以实现登录，并了解有关 Xbox Live 编程的详细信息了。
| [调用 Xbox Live 的最佳做法](using-xbox-live/best-practices/best-practices-for-calling-xbox-live.md) | 熟悉有关 Xbox Live 调用模式和最佳做法的基本知识，以确保你的作品运行良好，并且不受速率限制。
...
Xbox Live 社交功能可以有机增加你的受众，在 5,500 多万名活跃用户中扩大你的知名度。  本部分介绍了如何开始使用 Xbox Live 的社交功能。
...
| [Xbox 集成的多人游戏](multiplayer/xbox-integrated-multiplayer.md) | Xbox 集成多人游戏 (XIM) 是一个简单的自包含界面，用于将多人游戏、实时网络和聊天添加到你的作品中。 |
| [多人游戏管理器](multiplayer/multiplayer-manager.md) | 多人游戏管理器提供了以常见的多人游戏方案为主的 API。 |

### <a name="xbox-live-storage-platform"></a>Xbox Live 存储平台

Xbox Live 存储平台提供了标题存储和连接存储。  它们是两种不同但又相互补充的服务。  通过连接存储，可以在云中实现游戏保存内容，以进行跨设备漫游，无论用户在何处登录。  通过标题存储，可以存储基于用户或标题并在不同用户之间共享的数据 blob。
...
| [标题存储](storage-platform/xbox-live-title-storage/xbox-live-title-storage.md) | 有关标题存储的概述和编程指导。 |
