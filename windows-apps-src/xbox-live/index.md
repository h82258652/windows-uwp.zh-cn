...
使用 Xbox Live 创意者计划与[合作伙伴中心](https://partner.microsoft.com/dashboard)帐户的任何人都可以生成一个可以在 Windows 10 电脑和 Xbox One 主机运行的通用 Windows 平台 (UWP) 的支持 Xbox Live 游戏。
