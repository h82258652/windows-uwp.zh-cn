...
| 主题 | 说明 |
|-------|-------------|
| [在 C++ 中创建 Windows 运行时组件](creating-windows-runtime-components-in-cpp.md) | 本主题介绍了如何使用 C + + 创建一个 Windows 运行时组件，它是一个组件，可从使用 C#、 Visual Basic、 c + + 或 Javascript 生成的通用 Windows 应用调用的 CX。 |
