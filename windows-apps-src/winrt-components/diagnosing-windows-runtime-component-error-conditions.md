...
| 错误编号 | 消息文本                                                                                                                                                                      |
|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| WME1059      | 多个{0}-参数重载{1}。{2}使用 Windows.Foundation.Metadata.DefaultOverloadAttribute 进行修饰。                                                            |
| WME1085      | {0}-参数重载{1}。{2}必须具有一个方法，指定为默认重载使用 Windows.Foundation.Metadata.DefaultOverloadAttribute 进行修饰。 |
...
> **注意**这些限制仅适用到公共类型，不适用于在实现中使用的专用类型。
...
> **注意**如果你更改返回值，名称而新名称与其他参数的名称，你将收到错误 WME1091。
