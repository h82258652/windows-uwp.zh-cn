...
> **重要**包含的示例代码在此处使用类型 （如 directx:: Xmfloat3 和 DirectX::XMFLOAT4X4） 和内联方法使用在 DirectXMath.h 中声明。 如果你剪切并粘贴该代码，则在你的项目中使用 \#include &lt;DirectXMath.h&gt;。
