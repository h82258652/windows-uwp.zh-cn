...
<table>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=38m33s">使用 Service Fabric 构建游戏：有关腾讯的实现 （视频） 的详细信息</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.halowaypoint.com/">343</a></td>
        <td><b>光环 5:Guardians</b>实现<a href="https://www.halowaypoint.com/spartan-companies">Halo:Spartan 公司</a>作为使用 Azure Cosmos DB （通过 DocumentDB API)，是为其速度和灵活性，因其自动索引功能而选择其社交游戏玩法平台。</td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-halo-5-guardians-implemented-social-gameplay-using-azure-documentdb/">使用 （通过 DocumentDB API) 的 Azure Cosmos DB 实现社交游戏玩法</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://web.ageofascent.com/">Illyriad Games</a></td>
        <td>Illyriad Games 制作的<b>崛起时代</b>，是一款可以在装有现代浏览器的设备上运行的大型多人在线 (MMO) 史诗般 3D 空间游戏。 因此可以在 PC、笔记本电脑、手机和其他移动设备上玩此款游戏，无需安装任何插件。该游戏使用 ASP.NET Core、 HTML5、 WebGL 和 Azure。</td>
        <td>
            <ul>
    ...
    <tr>
        <td><a href="https://www.nextgames.com/">下一步的游戏</a></td>
        <td>下一步的游戏是创建者的<b>行尸走肉：No Man's Land</b>视频游戏是基于 AMC 的原始序列。 《行尸走肉》游戏后端使用的是 Azure。 它有 1,000,000 下载在首周中，在第一周、 游戏变得 #1 iPhone 和 iPad 免费美国太平洋时区中的应用应用商店，#1 12 个国家/地区，免费的应用和 #1 13 个国家/地区的免费游戏。
        </td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-we-built-it-next-games-global-online-gaming-platform-on-azure/">我们如何构建它：在 Azure （带有视频博客） 上的下一步游戏全局在线游戏平台</a>
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">行尸走肉 》 使用 Azure Cosmos DB （通过 DocumentDB API) 进行更快的开发周期和更具吸引力的游戏玩法</a>
            </ul>
        </td>
    </tr>
    <tr>
...
* [Hitman 和 Azure:创建游戏功能，如难以捉摸目标才可以使用云的](https://channel9.msdn.com/Series/Hitman)
* [Azure 中作为 Hitcents、 游戏 Troopers 和 InnoSpark 的秘密武器](https://news.microsoft.com/features/game-developers-use-microsoft-azure-as-secret-sauce-for-scale-and-growth-2/)
* [使用 Azure 的 Bizspark 计划上的游戏初创企业](https://blogs.technet.microsoft.com/bizspark_featured_startups/2015/09/25/azure-open-for-gaming-startups/)
...
* build 2016:[CodeLabs&mdash;使用 Microsoft Azure 应用服务和 Microsoft SQL Azure 后端，在 Unity 中保存游戏得分](https://github.com/Microsoft-Build-2016/CodeLabs-GameDev-6-Azure)
* 生成 2017年:[使用 Microsoft Azure 的用户体验交付世界一流的游戏：从标题 Halo、 Hitman，和行尸走肉 （视频） 等到的经验教训](https://channel9.msdn.com/Events/Build/2017/P4062)
* 已将组可重用的构建基块、 项目、 服务和设计为支持在 GitHub 上使用 Azure 的常见游戏工作负荷的最佳做法：[有关 Azure 上的游戏的构建基块](https://github.com/MicrosoftDX/nether)
* [在 Azure （视频） 上的游戏服务](https://channel9.msdn.com/Series/Gaming-Services-on-Azure)
