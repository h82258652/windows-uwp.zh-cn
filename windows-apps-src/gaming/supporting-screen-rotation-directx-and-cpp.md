...
> **注意** 有关用于旋转的 2-D 转换以及如何定义它们的详细信息，请参阅[为屏幕旋转定义矩阵 (2-D)](#appendix-a-applying-matrices-for-screen-rotation-2-d)。 有关用于旋转的 3-D 转换的详细信息，请参阅[为屏幕旋转定义矩阵 (3-D)](#appendix-b-applying-matrices-for-screen-rotation-3-d)。
