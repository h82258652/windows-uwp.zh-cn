...
ms.locfileid: "80229449"
---
# <a name="game-technologies-for-uwp-apps"></a>适用于 UWP 应用的游戏技术

在此指南中，你将了解可用于开发通用 Windows 平台 (UWP) 游戏的技术。

##  <a name="benefits-of-windows10-for-game-development"></a>适用于游戏开发的 Windows 10 的优点

通过在 Windows 10 中引入 UWP，你的 Windows 10 标题将能够跨所有 Microsoft 平台。 通过从以前版本的 Windows 中免费迁移，Windows 10 客户端的数量将不断增加。 这两个方面的组合意味着，你的 Windows 10 标题将能够通过 Microsoft Store 向大量客户联系。

此外，Windows 10 提供了许多对游戏特别有用的新功能：

-   减少了内存分页和整体内存系统大小
-   经改进的图形内存管理可为前台游戏主动分配和保护更多内存

## <a name="uwp-games-with-c-and-directx"></a>具有和 DirectX C++的 UWP 游戏

需要高性能的实时游戏应充分利用 DirectX API。 DirectX 是用于创建需要高性能的游戏和多媒体应用程序（如 3D 游戏）的本机 API 集合。

## <a name="development-environment"></a>开发环境

若要创建适用于 UWP 的游戏，需要安装 Visual Studio 2015 或更高版本来设置开发环境。 建议安装最新版本的 Visual Studio，使你能够访问最新的开发和安全更新。 Visual Studio 允许你创建 UWP 应用并提供用于游戏开发的工具：
...
-   3D 图形 - Windows 10 支持两个 3D 图形 API 集：Direct3D 11 和 [Direct3D 12](/windows/win32/direct3d12/directx-12-programming-guide)。 这些 API 都提供创建 3D 和 2D 图形的功能。 Direct3D 11 和 Direct3D 12 不在一起使用，但是其中任何一个都可与 2D 图形和 UI 组中的任何 API 一起使用。 有关在游戏中使用图形 API 的详细信息，请参阅 [DirectX 游戏的基本 3D 图形](an-introduction-to-3d-graphics-with-directx.md)。
    ...
    <p>请参阅 <a href="/windows/win32/direct3d12/directx-12-programming-guide">Direct3d 12</a> 文档。</p></td>
    </tr>
    <tr>
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/direct3d11/atoc-dx-graphics-direct3d-11">Direct3D 11</a> 文档。</p></td>
    </tr>
    </tbody>
    </table>
...
-   2D 图形和 UI - 与 2D 图形（例如文本和用户界面）相关的 API。 所有 2D 图形和 UI API 都是可选项。
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/Direct2D/direct2d-portal">Direct2D</a> 文档。</p></td>
    </tr>
    <tr>
    ...
    <p></p>
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/DirectWrite/direct-write-portal">DirectWrite</a> 文档。</p></td>
    </tr>
    <tr>
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/directcomp/directcomposition-portal">DirectComposition</a> 文档。</p></td>
    </tr>
    </tbody>
    </table>
...
-   音频 - 与播放音频和应用音频效果相关的 API。 有关在游戏中使用音频 API 的信息，请参阅[游戏音频](working-with-audio-in-your-directx-game.md)。
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/xaudio2/xaudio2-apis-portal">XAudio2</a> 文档。</p></td>
    </tr>
    <tr>
    <td align="left">音频图</td>
    <td align="left"><p>对于可使用 XAudio2 实现的功能，可以改为使用 Windows 运行时音频图形 Api。 若要帮助你确定两种替代方法，请参阅<a href="/windows/uwp/audio-video-camera/audio-graphs#choosing-windows-runtime-audiograph-or-xaudio2">选择 Windows 运行时 AudioGraph 或 XAudio2</a>。</p>
    <p><strong>何时使用</strong></p>
    <p>如果游戏需要以最小的开销和延迟播放声音，但使用比 XAudio2 更简单易用的 API，并且具有C#支持选项，请使用音频图。</p>
    <p><strong>详细信息</strong></p>
    <p>请参阅<a href="/windows/uwp/audio-video-camera/audio-graphs">音频图</a>文档。</p></td>
    </tr>
    <tr>
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/medfound/microsoft-media-foundation-sdk">Microsoft 媒体基础</a>概述。</p></td>
    </tr>
    </tbody>
    </table>
...
-   输入 - 与从键盘、鼠标、游戏板和其他用户输入源的输入相关的 API。
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/xinput/xinput-game-controller-apis-portal">XInput</a> 文档。</p></td>
    </tr>
    <tr>
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/uwp/api/Windows.Gaming.Input">Windows.Gaming.Input</a> 文档。</p></td>
    </tr>
    <tr>
    ...
    <p><strong>详细信息</strong></p>
    <p>有关在游戏中使用鼠标或键盘的详细信息，请参阅<a href="/windows/uwp/gaming/tutorial--adding-move-look-controls-to-your-directx-game">适用于游戏的移动观看控件</a>。</p></td>
    </tr>
    </tbody>
    </table>
...
-   数学 - 与简化常用数学运算相关的 API。
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅 <a href="/windows/win32/dxmath/directxmath-portal">DirectXMath</a> 文档。</p></td>
    </tr>
    </tbody>
    </table>
...
-   网络 - 有关通过 Internet 或专用网络与其他计算机和设备通信的 API。
    ...
    <p><strong>详细信息</strong></p>
    <p>请参阅<a href="/windows/uwp/gaming/work-with-networking-in-your-directx-game">在你的游戏中使用网络</a>。</p></td>
    </tr>
    <tr>
...
[Xbox Live 创意者计划](https://developer.microsoft.com/games/xbox/xboxlive/creator)允许任何开发人员将 Xbox live 集成到其 UWP 游戏中并发布到 Xbox One 和 Windows 10。 你可以使用最少的开发时间，将 Xbox Live 社交体验（如登录、状态、排行榜等）集成到游戏中。 Xbox Live 社交功能旨在有机增加你的受众，在 5,500 多万名活跃玩家中扩大你的知名度。

如果想访问主 Xbox One 应用商店中特别推荐的更多 Xbox Live 功能、专门的营销和开发支持和机会，则你可以申请 [ID@Xbox](https://www.xbox.com/developers/id) 计划。 若要查看可用于 Xbox Live 创意者计划和 ID@Xbox 计划的功能，请参阅[功能表](/gaming/xbox-live/developer-program-overview.md#feature-table)。
...
### <a name="uwp-games-without-directx"></a>无 DirectX 的 UWP 游戏

具有最小性能要求的较简单的游戏（例如纸盘或棋盘游戏）可在不使用 DirectX 的情况下编写，并且不一定需要使用 C++ 编写。 此类游戏可使用 UWP 支持的任何语言，例如 C#、Visual Basic、C++ 和 HTML/JavaScript。 如果你的游戏不需要高性能和密集图形，请查阅 [JavaScript 和 HTML5 触摸游戏示例](https://code.msdn.microsoft.com/windowsapps/JavaScript-and-HTML5-touch-d96f6031)作为一个示例。
...
## <a name="submitting-a-game-to-the-microsoft-store"></a>向 Microsoft Store 提交游戏
