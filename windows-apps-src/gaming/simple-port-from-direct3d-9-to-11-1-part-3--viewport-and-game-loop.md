...
> **注意** Windows 提供指向资源，如源应用程序对象和[**CoreWindow**](https://msdn.microsoft.com/library/windows/apps/br208225)的托管的指针。 请参阅 [**(^) 的对象运算符的句柄**]https://msdn.microsoft.com/library/windows/apps/yk97tc08.aspx。
