...
<div class="alert">
<strong>注意</strong>着色器获取 UINT 值，但是如果 Direct3D 9 样式的整型需要浮点数 （0.0 f、 1.0 f...255.f)，只可以 UINT 转换为 float32 着色器中。
</div>
<div>
 
</div></td>
...
<div class="alert">
<strong>注意</strong>着色器获取 SINT 值，但如果 Direct3D 9 样式需要整型浮点数，则只需在 SINT 转换为 float32 着色器中。
</div>
<div>
 
</div></td>
