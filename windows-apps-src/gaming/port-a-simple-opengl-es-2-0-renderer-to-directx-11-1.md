...
# <a name="how-to-port-a-simple-opengl-es-20-renderer-to-direct3d-11"></a>如何：将简单的 OpenGL ES 2.0 呈现器移植到 Direct3D 11
...
> **注意**  本主题中的所有 OpenGL ES 2.0 代码都基于 Khronos Group 提供的 Windows API 实现，并且都使用 Windows C 编程语法。
...
<tbody>
<tr class="odd">
<td align="left"><p>[移植着色器对象](port-the-shader-config.md)</p></td>
<td align="left"><p>移植 OpenGL ES 2.0 中的简单呈现器时，第一步是在 Direct3D 11 中设置等效的顶点着色器和片段着色器对象，并且确保在编译之后主程序能够与着色器对象进行通信。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[移植顶点缓冲区和数据](port-the-vertex-buffers-and-data-config.md)</p></td>
...
<tr class="even">
<td align="left"><p>[绘制到屏幕](draw-to-the-screen.md)</p></td>
