...
[**Windows::Web::Http**](https://docs.microsoft.com/uwp/api/windows.web.http) 命名空间缺少方便函数。 因此，使用[**HttpClient**](https://docs.microsoft.com/uwp/api/Windows.Web.Http.HttpClient)的应用和此命名空间中的其他类需要使用**HRESULT**值。
...
* [使用数据报套接字进行连接](https://docs.microsoft.com/previous-versions/windows/apps/jj635238(v=win.10))
* [借助流套接字连接到网络资源](https://docs.microsoft.com/previous-versions/windows/apps/jj150599(v=win.10))
