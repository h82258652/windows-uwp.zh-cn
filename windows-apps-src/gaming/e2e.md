...
<table>
    ...
    <tr>
        <td>UWP 应用开发人员论坛</td>
        <td><a href="https://docs.microsoft.com/answers/topics/uwp.html">开发通用 Windows 平台应用</a></td>
    </tr>
    <tr>
        <td>桌面应用程序开发人员论坛</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/porting/wpsl-to-uwp-root">从 Windows Phone Silverlight 移动到 UWP</a></td>
    </tr>
    <tr>
