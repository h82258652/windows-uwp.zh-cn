...
* [规划和生成游戏使用 VSTS 的完整功能： 敏捷，CI & CD 端到端演示](https://channel9.msdn.com/Shows/Level-Up/Planning-and-building-games-using-the-full-power-of-VSTS-Agile-CI--CD-end-to-end-demo)-Rogan Ferguson
...
* [Agile 工具集 vsts](https://channel9.msdn.com/Shows/Level-Up/Agile-tooling-set-with-VSTS) -Rogan Ferguson、 James Montemagno
...
* [Unity 和 Visual Studio 中，更好地一起](https://channel9.msdn.com/Shows/Level-Up/Unity-and-Visual-Studio-better-together)-从 Unity Arturo Nunez
...
* [为什么 Candy Crush Windows 10 和 Microsoft 应用商店中](https://channel9.msdn.com/Shows/Level-Up/Why-Candy-Crush-on-Windows-10-and-in-Microsoft-Store)的 Alex von Roth 从 k
...
* [所做我游戏直接访问 – 您不认为发生了什么事情接下来...](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-I-Made-My-Game-Blind-Accessible--You-Wont-Believe-What-Happened-Next) -从 MetalPop 游戏 Michelle 圣马丁
...
* [辅助功能设置的 Ramping](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-Ramping-Up-Accessibility) -从 EA 体育 Karen Stevens
...
* [所有 Deaf 玩家想要执行是具有某些有趣](https://channel9.msdn.com/Shows/Level-Up/GAConf-2018-All-Deaf-Gamers-Wanna-Do-is-Have-Some-Fun)的面板扬声器： Chris Robinson 和 Kristen Piersa，辅助功能支持。 从 Microsoft Michael 安
...
* [Xbox andWindows 引入了空间音频功能](https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-002)-Scott Selfon
...
* [满足适用 Windows andXbox 聚合的 Microsoft Store](https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-006)的访问适用 Chandran
